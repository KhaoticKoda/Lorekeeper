      ...
      w = function (c, d) {
        ...
        if (
          ...
          a.extend(i, {
            ...
            renderCache: {},
            onSearchChange:
              null === d.loadThrottle ? i.onSearchChange : o(i.onSearchChange, d.loadThrottle),
          }),
    ...
    return (
      ...
      a.extend(w.prototype, {
        setup: function () {
          ...
          if (
            ...
            p.plugins.names.length &&
              ((n = 'plugin-' + p.plugins.names.join(' plugin-')), b.addClass(n), e.addClass(n)),
        ...
        onFocus: function (a) {
          ...
          b.ignoreFocus ||
            ...
            b.$activeItems.length ||
              (b.showInput(), b.setActiveItem(null), b.refreshOptions(!!b.settings.openOnFocus)),
            b.refreshState());
        },
        onBlur: function (a, b) {
          var c = this;
            ...
            b.length &&
              ...
              (!c && j(c)) ||
                ...
                g + f > e + c
                  ? k.$dropdown_content
                      .stop()
                      .animate({ scrollTop: i }, d ? k.settings.scrollDuration : 0)
                  : g < c &&
                    k.$dropdown_content
                      .stop()
                      .animate({ scrollTop: h }, d ? k.settings.scrollDuration : 0)));
        },
        selectAll: function () {
          var a = this;
        ...
        hideInput: function () {
          var a = this;
          a.setTextboxValue(''),
            a.$control_input.css({ opacity: 0, position: 'absolute', left: a.rtl ? 1e4 : -1e4 }),
            (a.isInputHidden = !0);
        },
        showInput: function () {
        ...
        getSearchOptions: function () {
          ...
          return (
            ...
            { fields: a.searchField, conjunction: a.searchConjunction, sort: b, nesting: a.nesting }
          );
        },
        search: function (b) {
          var c,
          ...
          for (
            ...
            for (
              ...
              (m = n[e]),
                ...
                h.hasOwnProperty(m) || ((h[m] = document.createDocumentFragment()), i.push(m)),
                h[m].appendChild(l);
          for (
            ...
            (m = i[c]),
              u.optgroups.hasOwnProperty(m) && h[m].childNodes.length
                ? ((p = document.createDocumentFragment()),
                  ...
                  p.appendChild(h[m]),
                  o.appendChild(
                    u.render('optgroup', a.extend({}, u.optgroups[m], { html: v(p), dom: p }))
                  ))
                : o.appendChild(h[m]);
          if (
            (y.html(o),
            u.settings.highlight && (y.removeHighlight(), x.query.length && x.tokens.length))
          )
        ...
        updateOption: function (b, c) {
          ...
          if (
            ...
            (j = l.options[b].$order),
              f !== b &&
                (delete l.options[b], -1 !== (g = l.items.indexOf(b)) && l.items.splice(g, 1, f)),
              (c.$order = c.$order || j),
              (l.options[f] = c),
          ...
          if (((a = a || {}), 1 === f.tagType)) {
            for (d = [], b = 0, c = f.items.length; b < c; b++)
              (e = f.options[f.items[b]][f.settings.labelField] || ''),
                d.push(
                  '<option value="' + l(f.items[b]) + '" selected="selected">' + l(e) + '</option>'
                );
            d.length ||
        ...
        deleteSelection: function (b) {
          ...
          if (
            !g.length ||
            ('function' == typeof l.settings.onDelete && !1 === l.settings.onDelete.apply(l, [g]))
          )
            return !1;
        ...
        render: function (b, c) {
          ...
          return (
            ...
            g &&
            (j(h.renderCache[b]) || (h.renderCache[b] = {}), h.renderCache[b].hasOwnProperty(d))
              ? h.renderCache[b][d]
      ...
      (a.fn.selectize = function (b) {
        var c = a.fn.selectize.defaults,
          ...
          n = function (b, c) {
            ...
            for (
              c.maxItems = b.attr('multiple') ? null : 1, p = b.children(), m = 0, n = p.length;
              m < n;
              m++
            )
      ...
      w.define('optgroup_columns', function (b) {
        ...
        (b.equalizeHeight || b.equalizeWidth) &&
          (m.after(this, 'positionDropdown', e), m.after(this, 'refreshOptions', e));
      }),
