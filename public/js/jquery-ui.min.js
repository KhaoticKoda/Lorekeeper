          ...
          ? (this.element
              ...
              .each(function () {
                ...
                return i.options.greedy &&
                  ...
                  c(s, t.extend(i, { offset: i.element.offset() }), i.options.tolerance, e)
                  ? ((n = !0), !1)
                  : void 0;
              }),
            n
      ...
      resize: function (e) {
        ...
        d[0] !== document && /static/.test(d.css('position')) && (c = l),
          h.left < (a._helper ? l.left : 0) &&
            ((a.size.width =
              a.size.width + (a._helper ? a.position.left - l.left : a.position.left - c.left)),
          ...
          (i = Math.abs(
            a.sizeDiff.width + (a._helper ? a.offset.left - c.left : a.offset.left - l.left)
          )),
          (s = Math.abs(
            a.sizeDiff.height + (a._helper ? a.offset.top - c.top : a.offset.top - l.top)
          )),
            ...
            this.selectees.each(function () {
              ...
              i &&
                ...
                'touch' === n.tolerance
                  ...
                  : 'fit' === n.tolerance &&
                    (h = u.left > o && r > u.right && u.top > a && l > u.bottom),
                h
        ...
        for (i = c.length - 1; i >= 0; i--)
          for (a = c[i][1], r = c[i][0], s = 0, h = r.length; h > s; s++)
            (l = t(r[s])),
              ...
              u.push({ item: l, instance: a, width: 0, height: 0, left: 0, top: 0 });
      },
      ...
      if ((0 > Z && ((Z += 12), te--), G))
        for (
          e = this._daylightSavingAdjust(
            new Date(G.getFullYear(), G.getMonth() - U[0] * U[1] + 1, G.getDate())
          ),
            e = Q && Q > e ? Q : e;
        ...
        for (x = '', this.maxRows = 4, D = 0; U[1] > D; D++) {
          ...
          for (
            M +=
              ...
              T +
              "'>" +
              (/all|left/.test(T) && 0 === k ? (Y ? o : s) : '') +
              (/all|right/.test(T) && 0 === k ? (Y ? s : o) : '') +
              this._generateMonthYearHeader(t, Z, te, Q, G, k > 0 || D > 0, f, m) +
          ...
          for (
            M += S + '</tr></thead><tbody>',
              ...
              this.maxRows = H,
              O = this._daylightSavingAdjust(new Date(te, Z, 1 - N)),
              z = 0;
            H > z;
            z++
          ) {
            for (
              ...
              (W = g ? g.apply(t.input ? t.input[0] : null, [O]) : [!0, '']),
                (F = O.getMonth() !== Z),
                (L = (F && !_) || !W[0] || (Q && Q > O) || (G && O > G)),
                (E +=
                  "<td class='" +
                  ...
                  (F && !v
                    ...
                    : ' ' +
                      W[1] +
                      (O.getTime() === X.getTime() ? ' ' + this._currentClass : '') +
                      (O.getTime() === j.getTime() ? ' ui-datepicker-today' : '')) +
                  "'" +
                  ...
                  (F && !v
                    ...
                    : L
                      ...
                      : "<a class='ui-state-default" +
                        (O.getTime() === j.getTime() ? ' ui-state-highlight' : '') +
          ...
          Z++,
            ...
            (M +=
              ...
              (J
                ? '</div>' +
                  (U[0] > 0 && D === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : '')
                : '')),
            (x += M);
        }
        y += x;
        ...
        return (
          ...
          f(l, function (t, o) {
            var a,
              ...
              h = o.space || 'rgba';
            return l
              ? ((a = s[h](l)), (s[u[h].cache] = a[u[h].cache]), (n = s._rgba = a._rgba), !1)
              : e;
          }),
              ...
              f(o.props, function (t, n) {
                ...
                null !== h &&
                  (null === a
                    ? (l[o] = h)
                    : (u.mod &&
                        (h - a > u.mod / 2 ? (a += u.mod) : a - h > u.mod / 2 && (a -= u.mod)),
                      (l[o] = i((h - a) * e + a, n))));
              }),
              this[n](l)
            );
  ...
  t.effects.define('blind', 'hide', function (e, i) {
    ...
    t.effects.define('bounce', function (e, i) {
      ...
      for (
        ...
        (s = {}),
          ...
          (c = l ? 2 * c : c / 2);
      l && ((s = { opacity: 0 }), (s[g] = (v ? '-=' : '+=') + c), a.animate(s, f, m)),
        a.queue(i),
        ...
        for (l = g.top + o * _, u = o - (c - 1) / 2, a = 0; d > a; a++)
          (r = g.left + a * v),
            ...
            p
              ...
              .animate(
                { left: r + (m ? 0 : h * v), top: l + (m ? 0 : u * _), opacity: m ? 1 : 0 },
                e.duration || 500,
                e.easing,
                s
              );
      ...
      t.effects.createPlaceholder(a),
        ...
        ('box' === d || 'both' === d) &&
          (n.from.y !== n.to.y &&
            ...
            (_ = t.effects.setTransition(a, l, n.to.y, _))),
          n.from.x !== n.to.x &&
            ((v = t.effects.setTransition(a, h, n.from.x, v)),
            (_ = t.effects.setTransition(a, h, n.to.x, _)))),
        ('content' === d || 'both' === d) &&
          n.from.y !== n.to.y &&
    ...
    t.effects.define('pulsate', 'show', function (e, i) {
      var s = t(this),
        ...
        c = 1,
        d = s.queue().length;
      for ((o || !s.is(':visible')) && (s.css('opacity', 0).show(), (u = 1)); l > c; c++)
