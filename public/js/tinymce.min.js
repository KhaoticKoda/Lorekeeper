...
!(function (j) {
  ...
  var e,
    ...
    oe = 'undefined' != typeof j.window ? j.window : Function('return this;')(),
    ie = function (e, t) {
      return (function (e, t) {
        for (
  ...
  var kt = function (e, t, n, r) {
      ...
      if (Ae.qsa && (!je || !je.test(e))) {
        if (
          ...
          for (
            ...
            l[s] = f + Ht(l[s]);
          (d = (Nt.test(e) && Ot(t.parentNode)) || t), (h = l.join(','));
        }
        if (h)
          try {
    ...
    return _e(e.replace(dt, '$1'), t, n, r);
  };
  function Tt() {
    var n = [];
  ...
  (_t.prototype = Re.filters = Re.pseudos),
    (Re.setFilters = new _t()),
    (Be = kt.tokenize =
      function (e, t) {
        var n,
          r,
      ...
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === c.length)) {
          ...
          for (
            ...
            if (
              (s = Re.find[u]) &&
              (r = s(a.matches[0].replace(zt, St), (Nt.test(i[0].type) && Ot(t.parentNode)) || t))
            ) {
              if ((i.splice(o, 1), !(e = r.length && Ht(i)))) return it.apply(n, r), n;
              break;
            }
        }
        return (l || Oe(e, c))(r, t, !Ue, n, (Nt.test(e) && Ot(t.parentNode)) || t), n;
      }),
    (Ae.sortStable = We.split('').sort(Ze).join('') === We),
  ...
  var Sn,
    ...
    jn = {
      unknown: function () {
        return Un({ current: undefined, version: Dn.unknown() });
      },
      nu: Un,
      windows: $(Pn),
      ios: $('iOS'),
    ...
    br = function (e, t) {
      return yr(e, t) ? T.from(e[t]) : T.none();
    },
    yr = function (e, t) {
      return hr.call(e, t);
    },
    ...
    Dr = function (e, t) {
      return Mr(e, t, Rr().DOCUMENT_POSITION_CONTAINED_BY);
    },
    Br = ar,
    Or = ir,
    _r = function (e, t) {
    ...
    jr = function (e) {
      return (t = Ar(e, Fr)), (n = Z.call(t, 0)).reverse(), n;
      var t, n;
    },
    qr = function (e) {
      return Ar(e, Ur);
    ...
    Yr = (Tr('element', 'offset'), nr.detect().browser),
    Gr = function (e) {
      return F(e, cr);
    },
    Jr = {
      getPos: function (e, t, n) {
        var r,
          ...
          s = e.ownerDocument;
        if (((n = n || e), t)) {
          if (n === e && t.getBoundingClientRect && 'static' === zr(or.fromDom(e), 'position'))
            return {
              x: (a =
                (o = t.getBoundingClientRect()).left +
  ...
  var so,
    ...
    wo = fo(['thead', 'tbody', 'tfoot']),
    xo = fo(['td', 'th']),
    No = fo(['pre', 'script', 'textarea', 'style']),
    Eo = function (t) {
      return function (e) {
      ...
      if (!_o.isElement(t) || !Ho(t)) {
        ...
        if (!1 === _o.isDocument(t)) {
          if (_o.isText(t) && 0 < t.nodeValue.length) {
            ...
            _o.isElement(t) &&
            (1 === (r = t.childNodes).length && Ho(r[0]) && t.parentNode.insertBefore(r[0], t),
            r.length || Co(or.fromDom(t)))
          )
            return;
          e.remove(t);
        }
  ...
  var Wo = function (e, t) {
      return e.replace(t ? Io : Fo, function (e) {
        return lo[e] || e;
      });
    },
    Ko = function (e, t) {
    ...
    oi = function (e) {
      var u,
        ...
        a = function (e, t, n) {
          ...
          for (
            t = t || '', 'string' == typeof (n = n || []) && (n = ri(n)), r = (e = ri(e)).length;
            r--;

          )
            (i = {
              attributes: a((o = ri([u, t].join(' ')))),
              attributesOrder: o,
              children: a(n, Jo),
            }),
              (s[e[r]] = i);
      ...
      return Go[e]
        ...
        : ((u = 'id accesskey class dir lang style tabindex title role'),
          ...
          Zo(ri('a form meter progress dfn'), function (e) {
    ...
    ii = function (e, n) {
      ...
      return (
        e &&
          ...
          'string' == typeof e && (e = { '*': e }),
          Zo(e, function (e, t) {
            r[t] = r[t.toUpperCase()] = 'map' === n ? Qo(e, /[, ]/) : ti(e, /[, ]/);
          })),
        r
      );
    };
  function ai(i) {
    var e,
      ...
      v = function (e, t, n) {
        ...
        return (
          r
            ? (r = Qo(r, /[, ]/, Qo(r.toUpperCase(), /[, ]/)))
            : (r = Go[e]) ||
              ((r = Qo(t, ' ', Qo(t.toUpperCase(), ' '))), (r = ei(r, n)), (Go[e] = r)),
          r
        );
      };
    (n = oi((i = i || {}).schema)),
      ...
      (e = ii(i.valid_styles)),
      (t = ii(i.invalid_styles, 'map')),
      (s = ii(i.valid_classes, 'map')),
      (r = v(
        'whitespace_elements',
    ...
    var z = function (e) {
      ...
      C = function (e) {
        var a = /^(~)?(.+)$/;
        e &&
          ((Go.text_block_elements = Go.block_elements = null),
          Zo(ri(e, ','), function (e) {
            var t = a.exec(e),
              n = '~' === t[1],
              r = n ? 'span' : 'div',
            ...
            if (((m[o] = m[r]), (g[o] = r), n || ((l[o.toUpperCase()] = {}), (l[o] = {})), !N[o])) {
              var i = N[r];
              delete (i = ei({}, i)).removeEmptyAttrs, delete i.removeEmpty, (N[o] = i);
            }
            Zo(m, function (e, t) {
              e[r] && ((m[t] = e = ei({}, m[t])), (e[o] = e[r]));
            });
          }));
      },
      w = function (e) {
    ...
    return (
      i.valid_elements
        ...
        : (Zo(n, function (e, t) {
          ...
          'html5' !== i.schema &&
            Zo(ri('strong/b em/i'), function (e) {
              (e = ri(e, '/')), (N[e[1]].outputName = e[0]);
            }),
          Zo(ri('ol ul sub sup blockquote span font a table tbody tr strong em b i'), function (e) {
            N[e] && (N[e].removeEmpty = !0);
          }),
          Zo(ri('p h1 h2 h3 h4 h5 h6 th td pre div address caption li'), function (e) {
            N[e].paddEmpty = !0;
          }),
          Zo(ri('span'), function (e) {
      ...
      Zo(
        ...
        function (e, t) {
          N[t] && (N[t].parentsRequired = ri(e));
        }
      ),
      i.invalid_elements &&
        Zo(ti(i.invalid_elements), function (e) {
          N[e] && delete N[e];
        }),
          ...
          for (
            ...
            if (
              ...
              'font-weight' === n && '700' === r
                ...
                (r = (r = r.replace(w, ui)).replace(x, b)),
                (l[n] = o ? g(r, !0) : r);
            }
          d('border', '', !0),
            d('border', '-width'),
    ...
    var r = {},
      ...
      e = (function U(m, g) {
        ...
        var y = function (e) {
          ...
          t = function (t) {
            return to.nu(function (e) {
              n(t, q(e, $(ao.value(t))), q(e, $(ao.error(t))));
            });
          },
          o = function (e) {
            return e.fold(W, W);
            ...
            ? (e || (e = ''),
              ...
              ci(e.split(','), function (e) {
                ...
                (e = Gt._addCacheSuffix(e)),
                  o[e] ||
                    ((o[e] = !0),
                    (t = M('link', { rel: 'stylesheet', href: e })),
                    n.appendChild(t));
              }))
            : bi.DOM.loadCSS(e);
        },
        ...
        isEmpty: function (e, t) {
          ...
          if ((e = e.firstChild)) {
            ...
            do {
              ...
              if (3 === o && e.parentNode && i[e.parentNode.nodeName] && mi.test(e.nodeValue))
                return !1;
              e = a.next();
            } while (e);
          }
        ...
        split: function (e, t, n) {
          ...
          if (e && t)
            return (
              ...
              (r = a.extractContents()),
              (a = P()).setStart(t.parentNode, vi(t) + 1),
              a.setEnd(e.parentNode, vi(e) + 1),
              (o = a.extractContents()),
              (i = e.parentNode).insertBefore(Lo.trimNode(F, r), e),
              n ? i.insertBefore(n, e) : i.insertBefore(t, e),
              i.insertBefore(Lo.trimNode(F, o), e),
              O(e),
              n || t
            );
        },
  ...
  ((li = bi || (bi = {})).DOM = li(j.document)), (li.nodeIndex = vi);
  var yi = bi,
    Ci = yi.DOM,
    wi = Gt.each,
    xi = Gt.grep,
            ...
            (o = function () {
              ...
              if (
                ...
                (l.length = 0),
                  wi(t, function (e) {
                    0 === i.length
                      ? Ni(e.success) && e.success.call(e.scope)
                      : Ni(e.failure) && e.failure.call(e.scope, i);
                  });
              }
            })();
        });
    };
  Ei.ScriptLoader = new Ei();
  var zi,
    Si = function () {
      return (Si =
        Object.assign ||
    ...
    Ri = {
      ...
      add: function (e, t) {
        var n = Ti[e];
        for (var r in (n || (Ti[e] = n = {}), t)) n[r.toLowerCase()] = t[r];
      },
      translate: function (e) {
        ...
        if (i(e)) return s('');
        if (R((t = e)) && yr(t, 'raw')) return s(o(e.raw));
        if (M((n = e)) && 1 < n.length) {
          var l = e.slice(1);
          return s(
            u(
              a(e[0]).replace(/\{([0-9]+)\}/g, function (e, t) {
                return yr(l, t) ? o(l[t]) : e;
              })
            )
          );
        }
    ...
    var r = this,
      ...
      c = function (e, n, t, r) {
        ...
        Mi(o, function (e) {
          ...
          t && (r ? t.call(r) : t.call(Ei));
      },
      f = function (e, t, n, r, o) {
        if (!a[e]) {
          var i = 'string' == typeof t ? t : t.prefix + t.resource + t.suffix;
          0 !== i.indexOf('/') && -1 === i.indexOf('://') && (i = Di.baseURL + '/' + i),
    ...
    return {
      ...
      requireLangPack: function (e, t) {
        ...
        if (n && !1 !== Di.languageLoad) {
          ...
          Ei.ScriptLoader.add(a[e] + '/langs/' + n + '.js');
        }
      },
      add: function (t, e, n) {
  ...
  ((zi = Di || (Di = {})).PluginManager = zi()), (zi.ThemeManager = zi());
  var Bi = function (t, n) {
    ...
    qi = function (e, t) {
      return (o = t), (i = Ui((n = e), (r = 'class')).concat([o])), wr(n, r, i.join(' ')), !0;
      var n, r, o, i;
    },
    $i = function (e, t) {
      return (
    ...
    Wi = function (e, t) {
      ji(e) ? e.dom().classList.add(t) : qi(e, t);
    },
    Ki = function (e) {
      0 === (ji(e) ? e.dom().classList : Ui(e, 'class')).length && Er(e, 'class');
    },
    Xi = function (e, t) {
    ...
    Gi = function (e, t) {
      return (
        ...
        Hr(o) ? [] : K(o.querySelectorAll(n), or.fromDom)
      );
      var n, r, o;
    };
  ...
  var Qi,
    ...
    na = function (e, t) {
      return (
        (n = t),
        (o = (r = e) === undefined ? j.document : r.dom()),
        Hr(o) ? T.none() : T.from(o.querySelector(n)).map(or.fromDom)
      );
      var n, r, o;
    },
    ra = function (e, t, n) {
      return Ji(_r, ta, e, t, n);
    },
    oa = $('mce-annotation'),
    ia = $('data-mce-annotation'),
    ...
    ua = function (r, e) {
      var t = r.selection.getRng(),
        ...
        s = function (e, t) {
          return (
            (n = t),
            (r = e.dom()) && r.hasAttribute && r.hasAttribute(n) ? T.some(Nr(e, t)) : T.none()
          );
          var n, r;
        };
    ...
    la = function (i, e) {
      var n,
        ...
        u = function (e, t) {
          var n = a.get(),
            r = t(n.hasOwnProperty(e) ? n[e] : { listeners: [], previous: ki(T.none()) });
          (n[e] = r), a.set(n);
        },
        t =
          ((n = function () {
    ...
    ca = function (e, n) {
      e.on('init', function () {
        e.serializer.addNodeFilter('span', function (e) {
          L(e, function (t) {
            var e;
            ((e = t), T.from(e.attributes.map[ia()]).bind(n.lookup)).each(function (e) {
    ...
    ba = pa,
    ya = function (e) {
      return e.replace(new RegExp(pa, 'g'), '');
    },
    Ca = _o.isElement,
    wa = _o.isText,
    xa = function (e) {
      return wa(e) && (e = e.parentNode), Ca(e) && e.hasAttribute('data-mce-caret');
    },
    Na = function (e) {
      return wa(e) && va(e.data);
    },
    Ea = function (e) {
      return xa(e) || Na(e);
    },
    ...
    Sa = function (e) {
      ...
      return (
        !(!e || !_o.isText(t)) &&
        (t.data.charAt(e.offset()) === ba || (e.isAtStart() && Na(t.previousSibling)))
      );
    },
    ka = function (e) {
      var t = e.container();
      return (
        !(!e || !_o.isText(t)) &&
        (t.data.charAt(e.offset() - 1) === ba || (e.isAtEnd() && Na(t.nextSibling)))
      );
    },
    Ta = function (e, t, n) {
      var r, o, i;
    ...
    Aa = function (e) {
      return wa(e) && e.data[0] === ba;
    },
    Ra = function (e) {
      return wa(e) && e.data[e.data.length - 1] === ba;
    },
    Ma = function (e) {
    ...
    Da = _o.isContentEditableTrue,
    Ba = _o.isContentEditableFalse,
    Oa = _o.isBr,
    _a = _o.isText,
    Ha = _o.matchNodeNames('script style textarea'),
    Pa = _o.matchNodeNames('img input textarea hr iframe video audio object'),
    La = _o.matchNodeNames('table'),
    Va = Ea,
    Ia = function (e) {
      return !Va(e) && (_a(e) ? !Ha(e.parentNode) : Pa(e) || Oa(e) || La(e) || Fa(e));
    },
    Fa = function (e) {
      return (
        !1 === ((t = e), _o.isElement(t) && 'true' === t.getAttribute('unselectable')) && Ba(e)
      );
      var t;
    },
    Ua = function (e, t) {
    ...
    $a = function (e, t) {
      return (e = qa(e)), t || (e.left = e.left + e.width), (e.right = e.left), (e.width = 0), e;
    },
    Wa = function (e, t, n) {
      return 0 <= e && e <= Math.min(t.height, n.height) / 2;
    },
    Ka = function (e, t) {
      return e.bottom - e.height / 2 < t.top || (!(e.top > t.bottom) && Wa(t.top - e.bottom, e, t));
    },
    Xa = function (e, t) {
      return e.top > t.bottom || (!(e.bottom < t.top) && Wa(t.bottom - e.top, e, t));
    },
    Ya = function (e) {
    ...
    Qa = function (e) {
      return 'string' == typeof e && 768 <= e.charCodeAt(0) && Ja.test(e);
    },
    Za = function (e, t) {
    ...
    ru = _o.isElement,
    ou = Ia,
    iu = _o.matchStyleValues('display', 'block table'),
    au = _o.matchStyleValues('float', 'left right'),
    uu = tu(ru, ou, y(au)),
    su = y(_o.matchStyleValues('white-space', 'pre pre-line pre-wrap')),
    lu = _o.isText,
    cu = _o.isBr,
    fu = yi.nodeIndex,
    du = Ga,
    ...
    bu = function (e) {
      var t, n, r, o, i, a, u, s;
      return (
        (t = 0 < (n = e.getClientRects()).length ? qa(n[0]) : qa(e.getBoundingClientRect())),
        !gu(e) && cu(e) && vu(t)
          ? ((i = (r = e).ownerDocument),
            (a = hu(i)),
    ...
    Cu = function (e) {
      var t,
        ...
        i = function (e, t) {
          var n = hu(e.ownerDocument);
          if (t < e.data.length) {
            if (Qa(e.data[t])) return r;
            if (Qa(e.data[t - 1]) && (n.setStart(e, t), n.setEnd(e, t + 1), !pu(n)))
              return o(yu(bu(n), !1)), r;
          }
          0 < t && (n.setStart(e, t - 1), n.setEnd(e, t), pu(n) || o(yu(bu(n), !1))),
            t < e.data.length && (n.setStart(e, t), n.setEnd(e, t + 1), pu(n) || o(yu(bu(n), !0)));
        };
      if (lu(e.container())) return i(e.container(), e.offset()), r;
      if (ru(e.container()))
        if (e.isAtEnd())
          (n = du(e.container(), e.offset())),
            lu(n) && i(n, n.data.length),
            uu(n) && !cu(n) && o(yu(bu(n), !1));
        else {
          if (((n = du(e.container(), e.offset())), lu(n) && i(n, 0), uu(n) && e.isAtEnd()))
            return o(yu(bu(n), !1)), r;
          (t = du(e.container(), e.offset() - 1)),
            uu(t) && !cu(t) && (iu(t) || iu(n) || !uu(n)) && o(yu(bu(t), !1)),
            uu(n) && o(yu(bu(n), !0));
        }
      return r;
    };
  function wu(t, n, e) {
    ...
    return {
      ...
      toRange: function () {
        var e;
        return (e = hu(t.ownerDocument)).setStart(t, n), e.setEnd(t, n), e;
      },
      getClientRects: r,
      isVisible: function () {
        return 0 < r().length;
  ...
  ((Qi = wu || (wu = {})).fromRangeStart = function (e) {
    ...
    (Qi.after = function (e) {
      return Qi(e.parentNode, fu(e) + 1);
    }),
    (Qi.before = function (e) {
      return Qi(e.parentNode, fu(e));
    }),
    (Qi.isAbove = function (e, t) {
      return Za([te(t.getClientRects()), ne(e.getClientRects())], Ka).getOr(!1);
    }),
    (Qi.isBelow = function (e, t) {
      return Za([ne(t.getClientRects()), te(e.getClientRects())], Xa).getOr(!1);
    }),
  ...
  var xu,
    ...
    Au = function (e) {
      return e
        ? $t.reduce(
            e.childNodes,
            function (e, t) {
              return Su(t) && 'BR' !== t.nodeName ? (e = e.concat(Au(t))) : e.push(t), e;
            },
            []
          )
        : [];
    ...
    Mu = function (e) {
      var t, r, n, o;
      return (
        (zu(e) ? 'text()' : e.nodeName.toLowerCase()) +
        '[' +
        ((r = Au(Tu((t = e)))),
        (n = $t.findIndex(r, Ru(t), t)),
        (r = r.slice(0, n + 1)),
        (o = $t.reduce(
          r,
          function (e, t, n) {
            return zu(t) && zu(r[n - 1]) && e++, e;
          },
          0
        )),
        (r = $t.filter(r, _o.matchNodeNames(t.nodeName))),
        (n = $t.findIndex(r, Ru(t), t)) - o) +
        ']'
      );
    },
    Du = function (e, t) {
      ...
      return (
        ...
        zu(n)
          ? (o = (function (e, t) {
              for (; (e = e.previousSibling) && zu(e); ) t += e.data.length;
              return t;
            })(n, r))
          ...
          (r = $t.reduce(
              ...
              return (t = /([\w\-\(\)]+)\[([0-9]+)\]/.exec(t))
                ? ('text()' === t[1] && (t[1] = '#text'),
                  ...
                  (i = $t.filter(i, function (e, t) {
                    return !zu(e) || !zu(i[t - 1]);
                  })),
                  (i = $t.filter(i, _o.matchNodeNames(r)))[o])
                : null;
              var n, r, o, i;
            },
            e
            ...
            ? zu(r)
              ? (function (e, t) {
                  ...
                  return zu(e) && t > e.data.length && (t = e.data.length), Eu(e, t);
                })(r, parseInt(o, 10))
              : ((o = 'after' === o ? ku(r) + 1 : ku(r)), Eu(r.parentNode, o))
            : null)
        : null;
    },
    Ou = function (e, t) {
      _o.isText(t) && 0 === t.data.length && e.remove(t);
    },
    _u = function (e, t, n) {
      var r, o, i, a, u, s, l;
      _o.isDocumentFragment(n)
        ? ((i = e),
          (a = t),
          (u = n),
          ...
          a.insertNode(u),
          s.each(function (e) {
            return Ou(i, e.previousSibling);
          }),
          l.each(function (e) {
            return Ou(i, e.nextSibling);
          }))
        : ((r = e), (o = n), t.insertNode(o), Ou(r, o.previousSibling), Ou(r, o.nextSibling));
    },
    Hu = _o.isContentEditableFalse,
    ...
    Iu = function (e) {
      return Vu(e, !0), Vu(e, !1), e;
    },
    Fu = function (e, t) {
      var n;
      if (_o.isElement(e) && ((e = Ga(e, t)), Hu(e))) return e;
      if (Ea(e)) {
        if ((_o.isText(e) && xa(e) && (e = e.parentNode), (n = e.previousSibling), Hu(n))) return n;
        if (((n = e.nextSibling), Hu(n))) return n;
      }
    },
    Uu = function (e, t, n) {
      var r = n.getNode(),
        o = r ? r.nodeName : null,
        i = n.getRng();
      if (Hu(r) || 'IMG' === o) return { name: o, index: Lu(n.dom, o, r) };
      var a,
        u,
        s,
        l,
        ...
        f,
        d,
        h = Fu((a = i).startContainer, a.startOffset) || Fu(a.endContainer, a.endOffset);
      return h
        ? { name: (o = h.tagName), index: Lu(n.dom, o, h) }
        : ((u = e),
          (l = t),
          (c = i),
          (f = (s = n).dom),
          ((d = {}).start = Pu(f, u, l, c, !0)),
          s.isCollapsed() || (d.end = Pu(f, u, l, c, !1)),
          d);
    },
    ju = function (e, t, n) {
    ...
    qu = function (e, t) {
      var n = e.dom,
        ...
        a = e.getNode(),
        u = a.nodeName;
      if ('IMG' === u) return { name: u, index: Lu(n, u, a) };
      var s = Iu(r.cloneRange());
      if (!i) {
        s.collapse(!1);
        var l = ju(n, o + '_end', t);
        _u(n, s, l);
    ...
    $u = {
      getBookmark: function (e, t, n) {
        return 2 === t
          ...
          : 3 === t
            ? ((o = (r = e).getRng()),
              {
                start: Du(r.dom.getRoot(), Eu.fromRangeStart(o)),
                end: Du(r.dom.getRoot(), Eu.fromRangeEnd(o)),
              })
            : t
              ? { rng: e.getRng() }
              : qu(e, !1);
      ...
      getUndoBookmark: d(Uu, W, !0),
      getPersistentBookmark: qu,
    },
    Wu = '_mce_caret',
    Ku = function (e) {
      return _o.isElement(e) && e.id === Wu;
    },
    Xu = function (e, t) {
      for (; t && t !== e; ) {
        if (t.id === Wu) return t;
    ...
    ts = function (e, t) {
      var n,
        ...
        a = ((n = re(i.childNodes)), (r = e), (o = H(n, r)), -1 === o ? T.none() : T.some(o))
          .map(function (e) {
            return e < t.offset() ? Eu(i, t.offset() - 1) : t;
          })
          .getOr(t);
      return rs(e), a;
    },
    ns = function (e, t) {
      return Gu(e) && t.container() === e
        ? ((r = t),
          ...
          0 < (a = o.text + i.text).length ? (Qu(n, a), Eu(n, r.offset() - o.count)) : r)
        : es(e, t);
      var n, r, o, i, a;
    },
    rs = function (e) {
      if ((Yu(e) && Ea(e) && (za(e) ? e.removeAttribute('data-mce-caret') : Ju(e)), Gu(e))) {
        var t = ya(
          (function (e) {
            try {
              return e.nodeValue;
    ...
    is = nr.detect().browser,
    as = _o.isContentEditableFalse,
    us = function (e, t, n) {
      var r,
        o,
        i,
    ...
    ss = function (a, u, e) {
      ...
      return {
        show: function (t, e) {
          var n, r, o;
          if ((c(), (o = e), _o.isElement(o) && /^(TD|TH)$/i.test(o.tagName))) return null;
          if (!u(e))
            return (
              (s = (function (e, t) {
                var n, r, o;
                if (((r = e.ownerDocument.createTextNode(ba)), (o = e.parentNode), t)) {
                  if (((n = e.previousSibling), wa(n))) {
                    if (Ea(n)) return n;
                    if (Ra(n)) return n.splitText(n.data.length - 1);
                  }
                  o.insertBefore(r, e);
                } else {
                  if (((n = e.nextSibling), wa(n))) {
                    if (Ea(n)) return n;
          ...
          (s = Ta('p', e, t)), (n = us(a, e, t)), pn(s).css('top', n.top);
    ...
    ls = function () {
      return is.isIE() || is.isEdge() || is.isFirefox();
    },
    cs = function (e) {
      return as(e) || (_o.isTable(e) && ls());
    },
    fs = _o.isContentEditableFalse,
    ds = _o.matchStyleValues('display', 'block table table-cell table-caption list-item'),
    hs = Ea,
    ms = xa,
    gs = _o.isElement,
    ps = Ia,
    ...
    ys = function (e, t) {
      for (var n; (n = e(t)); ) if (!ms(n)) return n;
      return null;
    },
    Cs = function (e, t, n, r, o) {
      var i = new uo(e, r);
      if (bs(t)) {
        if ((fs(e) || ms(e)) && n((e = ys(i.prev, !0)))) return e;
        for (; (e = ys(i.prev, o)); ) if (n(e)) return e;
      }
      if (vs(t)) {
        if ((fs(e) || ms(e)) && n((e = ys(i.next, !0)))) return e;
    ...
    Ns = function (e, t) {
      var n, r;
      return t ? ((n = t.container()), (r = t.offset()), gs(n) ? n.childNodes[r + e] : null) : null;
    },
    Es = function (e, t) {
    ...
    Ts = function (e, t, n) {
      var r,
        ...
        u = d(zs, !0, t),
        s = d(zs, !1, t);
      if (((o = n.startContainer), (i = n.startOffset), xa(o))) {
        if (
          (gs(o) || (o = o.parentNode),
          'before' === (a = o.getAttribute('data-mce-caret')) && ((r = o.nextSibling), cs(r)))
        )
          return Ss(r);
        if ('after' === a && ((r = o.previousSibling), cs(r))) return ks(r);
      }
      if (!n.collapsed) return n;
      if (_o.isText(o)) {
        if (hs(o)) {
          if (1 === e) {
            if ((r = s(o))) return Ss(r);
        ...
        if (Ra(o) && i >= o.data.length - 1) return 1 === e && (r = s(o)) ? Ss(r) : n;
        if (Aa(o) && i <= 1) return -1 === e && (r = u(o)) ? ks(r) : n;
        if (i === o.data.length) return (r = s(o)) ? Ss(r) : n;
        if (0 === i) return (r = u(o)) ? ks(r) : n;
      }
      return n;
    },
    As = function (e, t) {
      return T.from(Ns(e ? 0 : -1, t)).filter(fs);
    },
    Rs = function (e, t, n) {
      var r = Ts(e, t, n);
    ...
    Bs = function (e, t) {
      var n = xs(e, t);
      return !(n || !_o.isBr(e.getNode())) || n;
    };
  ((Nu = xu || (xu = {}))[(Nu.Backwards = -1)] = 'Backwards'), (Nu[(Nu.Forwards = 1)] = 'Forwards');
  var Os = _o.isContentEditableFalse,
    _s = _o.isText,
    Hs = _o.isElement,
    Ps = _o.isBr,
    Ls = Ia,
    ...
    Us = function (e, t) {
      if (vs(e)) {
        if (Ls(t.previousSibling) && !_s(t.previousSibling)) return Eu.before(t);
        if (_s(t)) return Eu(t, 0);
      }
      if (bs(e)) {
        if (Ls(t.nextSibling) && !_s(t.nextSibling)) return Eu.after(t);
        if (_s(t)) return Eu(t, t.data.length);
      }
      return bs(e) ? (Ps(t) ? Eu.before(t) : Eu.after(t)) : Eu.before(t);
    },
    js = function (e, t, n) {
      var r, o, i, a, u;
      if (!Hs(n) || !t) return null;
      if (t.isEqual(Eu.after(n)) && n.lastChild) {
        if (((u = Eu.after(n.lastChild)), bs(e) && Ls(n.lastChild) && Hs(n.lastChild)))
          return Ps(n.lastChild) ? Eu.before(n.lastChild) : u;
      } else u = t;
      var s,
        l,
        c,
        ...
        d = u.offset();
      if (_s(f)) {
        if (bs(e) && 0 < d) return Eu(f, --d);
        if (vs(e) && d < f.length) return Eu(f, ++d);
        r = f;
      } else {
        if (bs(e) && 0 < d && ((o = Fs(f, d - 1)), Ls(o)))
          return !Vs(o) && (i = Cs(o, e, Is, o))
            ? _s(i)
              ? Eu(i, i.data.length)
              : Eu.after(i)
            : _s(o)
              ? Eu(o, o.data.length)
              : Eu.before(o);
        if (vs(e) && d < f.childNodes.length && ((o = Fs(f, d)), Ls(o)))
          return Ps(o)
            ? ((s = n),
              (c = (l = o).nextSibling) && Ls(c)
                ? _s(c)
                  ? Eu(c, 0)
                  : Eu.before(c)
                : js(xu.Forwards, Eu.after(l), s))
            : !Vs(o) && (i = Cs(o, e, Is, o))
              ? _s(i)
                ? Eu(i, 0)
                : Eu.before(i)
      ...
      return ((vs(e) && u.isAtEnd()) || (bs(e) && u.isAtStart())) &&
        ((r = Cs(r, e, $(!0), n, !0)), Is(r, n))
        ? Us(e, r)
        : ((o = Cs(r, e, Is, n)),
          !(a = $t.last(
            V(
          ...
          (o && a.contains(o))
            ? o
              ? Us(e, o)
              : null
            : (u = vs(e) ? Eu.after(a) : Eu.before(a)));
    },
    qs = function (t) {
      return {
        next: function (e) {
          return js(xu.Forwards, e, t);
        },
        prev: function (e) {
          return js(xu.Backwards, e, t);
        },
      };
    },
    $s = function (e) {
      return Eu.isTextPosition(e) ? 0 === e.offset() : Ia(e.getNode());
    },
    Ws = function (e) {
      if (Eu.isTextPosition(e)) {
        var t = e.container();
    ...
    Ks = function (e, t) {
      return !Eu.isTextPosition(e) && !Eu.isTextPosition(t) && e.getNode() === t.getNode(!0);
    },
    Xs = function (e, t, n) {
      return e
        ? !Ks(t, n) && ((r = t), !(!Eu.isTextPosition(r) && _o.isBr(r.getNode()))) && Ws(t) && $s(n)
        : !Ks(n, t) && $s(t) && Ws(n);
      var r;
    },
    Ys = function (e, t, n) {
    ...
    Gs = function (t, n, r) {
      return Ys(t, n, r).bind(function (e) {
        return xs(r, e, n) && Xs(t, r, e) ? Ys(t, n, e) : T.some(e);
      });
    },
    Js = function (t, n, e, r) {
      return Gs(t, n, e).bind(function (e) {
        return r(e) ? Js(t, n, e, r) : T.some(e);
      });
    },
    Qs = function (e, t) {
      var n,
      ...
      return _o.isText(u)
        ? T.some(Eu(u, e ? 0 : u.data.length))
        : u
          ? Ia(u)
            ? T.some(e ? Eu.before(u) : ((a = u), _o.isBr(a) ? Eu.before(a) : Eu.after(a)))
            : ((r = t), (o = u), (i = (n = e) ? Eu.before(o) : Eu.after(o)), Ys(n, r, i))
          : T.none();
    },
    Zs = d(Ys, !0),
    el = d(Ys, !1),
    tl = {
      ...
      navigateIgnore: Js,
      positionIn: Qs,
      firstPositionIn: d(Qs, !0),
      lastPositionIn: d(Qs, !1),
    },
    nl = function (e, t) {
      return (
    ...
    rl = function (e, t) {
      return tl.lastPositionIn(e).fold(
        function () {
          return !1;
        },
        function (e) {
    ...
    ol = function (e, t, n) {
      return !(
        ...
        !Xu(e, t) ||
        ((o = n),
        (i = (r = t).ownerDocument.createTextNode(ba)),
        r.appendChild(i),
        o.setStart(i, 0),
        o.setEnd(i, 0),
        0)
    ...
    il = function (e, t, n, r) {
      ...
      if (s) {
        for (a = s[0], i = l, o = s.length - 1; 1 <= o; o--) {
          if (((u = i.childNodes), ol(l, i, r))) return !0;
          if (s[o] > u.length - 1) return !!ol(l, i, r) || rl(i, r);
          i = u[s[o]];
        }
      ...
      if (t) {
        if (((v = t), Gt.isArray(v.start)))
          return (
            (g = t),
            (p = (m = b).createRng()),
            il(m, !0, g, p) && il(m, !1, g, p) ? T.some(p) : T.none()
          );
        if ('string' == typeof t.start)
          return T.some(
            ((f = t),
            (d = (c = b).createRng()),
            (h = Bu(c.getRoot(), f.start)),
            d.setStart(h.container(), h.offset()),
            (h = Bu(c.getRoot(), f.end)),
        ...
        if (t.hasOwnProperty('id'))
          return (
            (s = ul((o = b), 'start', (i = t))),
            (l = ul(o, 'end', i)),
            Za([s, ((a = l), (u = s), a.isSome() ? a : u)], function (e, t) {
              var n = o.createRng();
              return (
                n.setStart(nl(o, e.container()), e.offset()),
                n.setEnd(nl(o, t.container()), t.offset()),
                n
              );
            })
          );
    ...
    fl = function (e) {
      return (
        _o.isElement(e) && 'SPAN' === e.tagName && 'bookmark' === e.getAttribute('data-mce-type')
      );
    },
    dl = function (e) {
    ...
    gl = {
      ...
      moveStart: function (e, t, n) {
        ...
        if (
          (n.startContainer !== n.endContainer ||
            !dl(n.startContainer.childNodes[n.startOffset])) &&
          1 === u.nodeType
        )
          for (
            a < (i = u.childNodes).length
              ? (r = new uo((u = i[a]), e.getParent(u, e.isBlock)))
              : (r = new uo((u = i[i.length - 1]), e.getParent(u, e.isBlock))).next(!0),
              o = r.current();
            o;
            o = r.next()
          )
            if (3 === o.nodeType && !hl(o)) return n.setStart(o, 0), void t.setRng(n);
      },
      getNonWhiteSpaceSibling: function (e, t, n) {
        if (e)
          for (t = t ? 'nextSibling' : 'previousSibling', e = n ? e : e[t]; e; e = e[t])
            if (1 === e.nodeType || !hl(e)) return e;
      },
      ...
      normalizeStyleValue: ml,
      getStyle: function (e, t, n) {
        return ml(e, e.getStyle(t, n), n);
      },
    ...
    Nl = function (e, t, n, r, o, i) {
      var a, u, s, l;
      if (3 === n.nodeType) {
        if (-1 !== (s = xl(o, i, n, r))) return { container: n, offset: s };
        l = n;
      }
      for (a = new uo(n, e.getParent(n, e.isBlock) || t); (u = a[o ? 'prev' : 'next']()); )
        if (3 !== u.nodeType || pl(u.parentNode)) {
          if (e.isBlock(u) || gl.isEq(u, 'BR')) break;
        } else if (-1 !== (s = xl(o, i, (l = u)))) return { container: u, offset: s };
      if (l) return { container: l, offset: (r = o ? 0 : l.length) };
    },
    El = function (e, t, n, r, o) {
      var i, a, u, s;
      for (
        3 === r.nodeType && 0 === r.nodeValue.length && r[o] && (r = r[o]), i = vl(e, r), a = 0;
        a < i.length;
        a++
      )
    ...
    zl = function (t, e, n, r) {
      ...
      if ((o && e[0].wrapper && (o = vl(i, o, 'ul,ol').reverse()[0] || o), !o))
        for (o = n; o[r] && !i.isBlock(o[r]) && ((o = o[r]), !gl.isEq(o, 'br')); );
      return o || n;
    },
    Sl = function (e, t, n, r, o, i, a) {
      var u, s, l, c, f, d;
      if (
        ((u = s = a ? n : o),
        (c = a ? 'previousSibling' : 'nextSibling'),
        (f = e.getRoot()),
        3 === u.nodeType && !bl(u) && (a ? 0 < r : i < u.nodeValue.length))
      )
        return u;
      for (;;) {
    ...
    kl = function (e, t, n, r) {
      var o,
        ...
        l = e.dom;
      return (
        1 === i.nodeType && i.hasChildNodes() && 3 === (i = Ga(i, a)).nodeType && (a = 0),
        1 === u.nodeType &&
          u.hasChildNodes() &&
          3 === (u = Ga(u, t.collapsed ? s : s - 1)).nodeType &&
          (s = u.nodeValue.length),
        (i = wl(l, i)),
        (u = wl(l, u)),
        (pl(i.parentNode) || pl(i)) &&
          ((i = pl(i) ? i : i.parentNode),
          3 === (i = t.collapsed ? i.previousSibling || i : i.nextSibling || i).nodeType &&
            (a = t.collapsed ? i.length : 0)),
        (pl(u.parentNode) || pl(u)) &&
          ((u = pl(u) ? u : u.parentNode),
          3 === (u = t.collapsed ? u.nextSibling || u : u.previousSibling || u).nodeType &&
            (s = t.collapsed ? 0 : u.length)),
        t.collapsed &&
          ((o = Nl(l, e.getBody(), i, a, !0, r)) && ((i = o.container), (a = o.offset)),
          (o = Nl(l, e.getBody(), u, s, !1, r)) && ((u = o.container), (s = o.offset))),
        n[0].inline &&
          (u = r
            ? u
            : (function (e, t) {
        ...
        (n[0].inline || n[0].block_expand) &&
          ((n[0].inline && 3 === i.nodeType && 0 !== a) || (i = Sl(l, n, i, a, u, s, !0)),
          (n[0].inline && 3 === u.nodeType && s !== u.nodeValue.length) ||
            (u = Sl(l, n, i, a, u, s, !1))),
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((i = El(l, n, t, i, 'previousSibling')), (u = El(l, n, t, u, 'nextSibling'))),
        (n[0].block || n[0].selector) &&
          ((i = zl(e, n, i, 'previousSibling')),
          (u = zl(e, n, u, 'nextSibling')),
          n[0].block &&
            (l.isBlock(i) || (i = Sl(l, n, i, a, u, s, !0)),
            l.isBlock(u) || (u = Sl(l, n, i, a, u, s, !1)))),
    ...
    Dl = function (r, o, i, a) {
      return Ir(o).fold(
        ...
        function (e) {
          return 'br' === a || (fr((n = o)) && '\ufeff' === Ml(n))
            ? 'valid'
            : cr((t = o)) && Xi(t, oa())
              ? 'existing'
              : Ku(o)
                ? 'caret'
                : gl.isValid(r, i, a) && gl.isValid(r, sr(e), i)
                  ? 'valid'
                  : 'invalid-child';
          var t, n;
        }
    ...
    _l = function (s, l, c, f) {
      s.undoManager.transact(function () {
        ...
        if (
          ...
          var i = Bl(s.getDoc(), f, l, c.decorate);
          ga(i, '\xa0'), s.selection.getRng().insertNode(i.dom()), s.selection.select(i.dom());
        } else {
          var a = $u.getPersistentBookmark(s.selection, !1),
            u = s.selection.getRng();
          Ol(s, u, l, c.decorate, f), s.selection.moveToBookmark(a);
        }
      });
    };
  function Hl(u) {
    ...
    Il = (function () {
      ...
      return (
        (a.create = function (e, t) {
          var n, r;
          if (((n = new a(e, Ll[e] || 1)), t)) for (r in t) n.attr(r, t[r]);
          return n;
        }),
        ...
        (a.prototype.getAll = function (e) {
          var t,
            n = [];
          for (t = this.firstChild; t; t = Vl(t, this)) t.name === e && n.push(t);
          return n;
        }),
        (a.prototype.empty = function () {
          var e, t, n;
          if (this.firstChild) {
            for (e = [], n = this.firstChild; n; n = Vl(n, this)) e.push(n);
            for (t = e.length; t--; )
        ...
        (a.prototype.isEmpty = function (e, t, n) {
          ...
          if (((t = t || {}), i))
            do {
              ...
              if (3 === i.type && !Pl.test(i.value)) return !1;
              if (3 === i.type && i.parent && t[i.parent.name] && Pl.test(i.value)) return !1;
              if (n && n(i)) return !1;
            } while ((i = Vl(i, this)));
          return !0;
        }),
        (a.prototype.walk = function (e) {
          return Vl(this, null, e);
        }),
        a
      );
    })(),
    ...
    return {
      parse: function (e) {
        var t,
          ...
          D = 0,
          B = Yo.decode,
          O = Gt.makeMap('src,href,data,background,formaction,poster,xlink:href'),
          _ = /((java|vb)script|mhtml):/i,
          H = function (e) {
            var t, n;
            for (t = M.length; t-- && M[t].name !== e; );
            if (0 <= t) {
              for (n = M.length - 1; t <= n; n--) (e = M[n]).valid && $(e.name);
              M.length = t;
            }
          },
        ...
        for (
          ...
          if ((R < t.index && j(B(e.substr(R, t.index - R))), (n = t[6])))
            ...
            ':' === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)),
              (l = n in s),
              A && E[n] && 0 < M.length && M[M.length - 1].name === n && H(n);
            var L = Ul(S, t[8]);
            if (null !== L) {
              if ('all' === L) {
                (R = Fl(I, e, z.lastIndex)), (z.lastIndex = R);
                continue;
              }
              f = !1;
            }
            ...
            l || (v && v.indexOf('/') === v.length - 1 ? f && $(n) : M.push({ name: n, valid: f }));
          } else
            (n = t[1])
              ? ('>' === n.charAt(0) && (n = ' ' + n),
        ...
        for (R < e.length && j(B(e.substr(R))), o = M.length - 1; 0 <= o; o--)
          (n = M[o]).valid && $(n.name);
      },
    };
  }
  ...
  var ql = jl,
    $l = function (e, t) {
      ...
      for (
        ...
        (r = f.lastIndex),
          (o = i[0].length),
          (n = a[i[1]] ? r : ql.findEndTag(d, c, r)),
          (c = c.substring(0, r - o) + c.substring(n)),
          (f.lastIndex = r - o);
      return ya(c);
    },
    Wl = { trimExternal: $l, trimInternal: $l },
    Kl = function (e, t, n) {
    ...
    Jl = function (e) {
      return Kl(e, 'body_id', 'tinymce');
    },
    Ql = function (e) {
      return Kl(e, 'body_class', '');
    },
    Zl = function (e) {
    ...
    xc = function (e) {
      ...
      return A(t) ? K(t.split(','), Xn) : M(t) ? t : !1 === t || e.inline ? [] : ['default'];
    },
    Nc = function (e, t, n) {
      var r, o, i, a, u;
      if (
        ...
        r = Gt.trim(Wl.trimExternal(e.serializer, n.innerHTML));
      ...
      return (
        'text' === t.format || No(or.fromDom(n)) ? (t.content = r) : (t.content = Gt.trim(r)),
  ...
  function zc(e) {
    ...
    return (
      (u = (e = e || {}).indent),
      (s = Ec(e.indent_before || '')),
      (l = Ec(e.indent_after || '')),
      (c = Yo.getEncodeFunc(e.entity_encoding || 'raw', e.entities)),
  ...
  var kc = function (e, t) {
      t(e), e.firstChild && kc(e.firstChild, t), e.next && kc(e.next, t);
    },
    Tc = function (e, t, n) {
    ...
    Mc = function (a) {
      if (!M(a)) throw new Error('cases must be an array');
    ...
    Dc =
      (Mc([{ before: ['element'] }, { on: ['element', 'offset'] }, { after: ['element'] }]),
      Mc([
        { domRange: ['rng'] },
        { relative: ['startSitu', 'finishSitu'] },
        { exact: ['start', 'soffset', 'finish', 'foffset'] },
      ])),
    Bc = Tr('start', 'soffset', 'finish', 'foffset'),
    Oc = (Dc.domRange, Dc.relative, Dc.exact, nr.detect().browser),
    _c = function (e, t) {
      var n = fr(t) ? Ml(t).length : $r(t).length + 1;
      return n < e ? n : e < 0 ? 0 : e;
    },
    Hc = function (e) {
      return Bc(e.start(), _c(e.soffset(), e.start()), e.finish(), _c(e.foffset(), e.finish()));
    },
    Pc = function (e, t) {
    ...
    Lc = function (t) {
      return function (e) {
        return Pc(t, e.start()) && Pc(t, e.finish());
      };
    },
    Vc = function (e) {
      return !0 === e.inline || Oc.isIE();
    },
    Ic = function (e) {
      return Bc(
    ...
    Fc = function (e) {
      ...
      return (t && 0 !== t.rangeCount ? T.from(t.getRangeAt(0)) : T.none()).map(Ic);
    },
    Uc = function (e) {
      var t,
        n = ((t = e.dom().ownerDocument.defaultView), or.fromDom(t));
      return Fc(n.dom()).filter(Lc(e));
    },
    jc = function (e, t) {
      return T.from(t).filter(Lc(e)).map(Hc);
    },
    qc = function (e) {
    ...
    $c = function (e) {
      return (e.bookmark ? e.bookmark : T.none()).bind(d(jc, or.fromDom(e.getBody()))).bind(qc);
    },
    Wc = function (e) {
      var t = Vc(e) ? Uc(or.fromDom(e.getBody())) : T.none();
    ...
    Yc = function (t, e) {
      return ((n = e),
      n.collapsed ? T.from(Ga(n.startContainer, n.startOffset)).map(or.fromDom) : T.none()).bind(
        function (e) {
          return wo(e) ? T.some(e) : !1 === Lr(t, e) ? T.some(t) : T.none();
        }
      );
      var n;
    },
    Gc = function (t, e) {
      Yc(or.fromDom(t.getBody()), e)
        .bind(function (e) {
    ...
    Qc = function (e) {
      var t,
        n = e.getBody();
      return n && ((t = or.fromDom(n)), Ac(t) || Rc(t).isSome());
    },
    Zc = function (e) {
      return e.inline ? Qc(e) : (t = e).iframeElement && Ac(or.fromDom(t.iframeElement));
      var t;
    },
    ef = function (e) {
      ...
      e.removed ||
        (t
          ...
          : (function (t) {
              ...
              if (t.$.contains(n, a)) return Jc(a), Gc(t, r), ef(t);
              t.bookmark !== undefined &&
                !1 === Zc(t) &&
                Xc(t).each(function (e) {
                  t.selection.setRng(e), (r = e);
                }),
                t.inline || (he.opera || Jc(n), t.getWin().focus()),
                (he.gecko || t.inline) && (Jc(n), Gc(t, r)),
                ef(t);
            })(e));
    },
    nf = Zc,
    ...
    of = function (e, t) {
      ...
      e.dom.setHTML(e.getBody(), t),
        nf((r = e)) &&
          tl.firstPositionIn(r.getBody()).each(function (e) {
            var t = e.getNode(),
              n = _o.isTable(t) ? tl.firstPositionIn(t).getOr(e) : e;
    ...
    af = function (u, s, l) {
      return (
        ...
        (l.set = !0),
        (l.content = rf(s) ? '' : s),
        rf(s) || l.no_events || (u.fire('BeforeSetContent', l), (s = l.content)),
        T.from(u.getBody()).fold($(s), function (e) {
          return rf(s)
            ? (function (e, t, n, r) {
                Tc(e.parser.getNodeFilters(), e.parser.getAttributeFilters(), n);
                var o = Sc({ validate: e.validate }, e.schema).serialize(n);
                return (
                  (r.content = No(or.fromDom(t)) ? o : Gt.trim(o)),
                  of(e, r.content),
            ...
            : ((t = u),
              ...
              0 === (r = s).length || /^\s+$/.test(r)
                ? ((a = '<br data-mce-bogus="1">'),
                  ...
                  (i = tc(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase())
                    ? ((r = a), (r = t.dom.createHTML(i, t.settings.forced_root_block_attrs, r)))
                    : r || (r = '<br data-mce-bogus="1">'),
                  of(t, r),
                  t.fire('SetContent', o))
                : ('raw' !== o.format &&
                    (r = Sc({ validate: t.validate }, t.schema).serialize(
                      t.parser.parse(r, { isRootContent: !0, insert: !0 })
                    )),
                  (o.content = No(or.fromDom(n)) ? r : Gt.trim(r)),
                  of(t, o.content),
    ...
    pf = function (e) {
      if (!e.removed) {
        ...
        r && e.save({ is_removing: !0 }),
          ...
          e.hasHiddenInput && o && mf.remove(o.nextSibling),
          lf(e),
          e.editorManager.remove(e),
          !e.inline && r && ((i = e), mf.setStyle(i.id, 'display', i.orgDisplay)),
          cf(e),
          mf.remove(e.getContainer()),
          gf(t),
          gf(n),
          e.destroy();
      }
        ...
        (t || e.removed
          ? (t ||
            ...
            (r = (n = e).formElement) &&
              ...
              mf.unbind(r, 'submit reset', n.formEventDelegate)),
    ...
    bf = Tr('sections', 'settings'),
    yf = nr.detect(),
    Cf = yf.deviceType.isTouch(),
    wf = yf.deviceType.isPhone(),
    xf = ['lists', 'autolink', 'autosave'],
    Nf = wf ? { theme: 'mobile' } : {},
    Ef = function (e) {
      var t = M(e) ? e.join(' ') : e,
        n = K(A(t) ? t.split(' ') : [], Xn);
    ...
    zf = function (e, t, n, r) {
      var o,
        i,
        a = Ef(n.forced_plugins),
        u = Ef(r.plugins),
        s = e && ((o = 'mobile'), t.sections().hasOwnProperty(o)) ? V(u, d(P, xf)) : u,
        l = ((i = s), [].concat(Ef(a)).concat(Ef(i)));
        ...
        p = Gt.extend(
            ...
            : {}),
          {
            ...
            external_plugins:
              ...
              a && a.external_plugins ? Gt.extend({}, a.external_plugins, s) : s),
          }
        );
      return zf(e, g, n, p);
    },
    ...
    Mf = function (e, t) {
      return parseInt(zr(t, e), 10);
    },
    Df = d(Rf, 'clientWidth'),
    Bf = d(Rf, 'clientHeight'),
    Of = d(Mf, 'margin-top'),
    _f = d(Mf, 'margin-left'),
    Hf = function (e, t, n) {
      var r,
        ...
        p =
          ...
          {
            x: a - (o ? s.left + i.dom().clientLeft + _f(i) : 0),
            y: u - (o ? s.top + i.dom().clientTop + Of(i) : 0),
          });
      return (
        (c = p.x), (f = p.y), (d = Df((l = g))), (h = Bf(l)), 0 <= c && 0 <= f && c <= d && f <= h
      );
    },
    Pf = function (e) {
      var t,
  ...
  function Vf(r) {
    ...
    return (
      ...
      {
        open: function (e, t) {
          r.editorManager.setActive(r), Wc(r);
          var n = o().open(e, t, u);
          return a(n), n;
        },
  ...
  var If,
    ...
    Uf = function (e, t) {
      var n = (function (e, t) {
        for (var n in Ff.urls) if (Ff.urls[n] + '/plugin' + t + '.js' === e) return n;
        return null;
      })(t, e.suffix);
      return n
        ? Ri.translate(['Failed to load plugin: {0} from url {1}', n, t])
        : Ri.translate(['Failed to load plugin url: {0}', t]);
    },
    jf = function (e, t) {
    ...
    Wf = {
      ...
      pluginInitError: function (e, t, n) {
        var r = Ri.translate(['Failed to initialize plugin: {0}', t]);
        $f(r, n), qf(e, r);
      },
      uploadError: function (e, t) {
        qf(e, Ri.translate(['Failed to upload image: {0}', t]));
      },
      displayError: qf,
      initError: $f,
    },
      ...
      0 !== r.src.indexOf('blob:')
        ? ((i = rd(r.src).data),
          (a = n.findFirst(function (e) {
            ...
            : td(r.src).then(
                function (e) {
                  (a = n.create(id(), e, i)), n.add(a), o({ image: r, blobInfo: a });
                },
                function (e) {
                  t(e);
                }
      ...
      d = function (e, t) {
        i.removeByUri(e.src),
          ...
          o
            .$(e)
            .attr({
              src: fc(o) ? t + '?' + new Date().getTime() : t,
              'data-mce-src': o.convertURL(t, 'src'),
            });
      },
      h = function (n) {
        return (
          t || (t = Jf(a, { url: hc(o), basePath: mc(o), credentials: gc(o), handler: pc(o) })),
          g().then(
            u(function (r) {
              var e;
              return (
                ...
                t.upload(e, f).then(
                  u(function (e) {
                    var t = K(e, function (e, t) {
                      var n = r[t].image;
                      return (
                        e.status && dc(o) ? d(n, e.url) : e.error && Wf.uploadError(o, e.error),
        ...
        return (
          ...
          n.findAll(o.getBody(), m).then(
            u(function (e) {
              return (
                (e = V(e, function (e) {
                  return 'string' != typeof e || (Wf.displayError(o, e), !1);
                })),
                L(e, function (e) {
  ...
  var fd = function (e, t, n) {
    ...
    pd = function (t, e, n) {
      return (
        (r = hd(or.fromDom(n), or.fromDom(e))),
        U(r, function (e) {
          return gd(t, e.dom());
        }).isSome()
      );
    ...
    bd = function (e) {
      ...
      if (
        ...
        _o.isElement(g) &&
        v &&
        ((c = p.nodeName.toLowerCase()), h.isValidChild(c, v.toLowerCase()) && !pd(m, p, g))
      ) {
        for (
          ...
          if (((b = m), (y = g), _o.isText(y) || (_o.isElement(y) && !gd(b, y) && !fl(y)))) {
            if (vd(m, g)) {
    ...
    wd = function (t) {
      return Kr(t).fold($([t]), function (e) {
        return [t].concat(wd(e));
      });
    },
    xd = function (t) {
      return Xr(t).fold($([t]), function (e) {
        return 'br' === sr(e)
          ? Fr(e)
              .map(function (e) {
                return [t].concat(xd(e));
              })
              .getOr([])
          : [t].concat(xd(e));
      });
    ...
    'onselectionchange' in i.getDoc() ||
      i.on('NodeChange Click MouseUp KeyUp Focus', function (e) {
        ...
        (n = {
          ...
          ('nodechange' !== e.type && Cd(n, r)) || i.fire('SelectionChange'),
          (r = n);
      }),
  ...
  var kd,
    ...
    Rd = function (e, t) {
      return (
        (n = (u = e).inline ? Ad(u.getBody()) : { left: 0, top: 0 }),
        (a = (i = e).getBody()),
          ...
          pageX:
            (o = (function (e, t) {
              ...
              var n,
                ...
                i,
                a,
                u = Ad(e.getContentAreaContainer()),
                s =
                  ((r = (n = e).getBody()),
    ...
    Md = _o.isContentEditableFalse,
    Dd = _o.isContentEditableTrue,
    Bd = function (e) {
    ...
    Od = function (u, s) {
      return function (e) {
        if (0 === e.button) {
          var t = F(s.dom.getParents(e.target), nu(Md, Dd)).getOr(null);
          if (((i = s.getBody()), Md((a = t)) && a !== i)) {
    ...
    Hd = function (e) {
      (e.dragging = !1), (e.element = null), Bd(e.ghost);
    },
    Pd = function (e) {
      var t,
        n,
      ...
      (t = yi.DOM),
        ...
        (r = function (e) {
          ...
          if (g.dragging) {
            var m = ((f = g), { pageX: (d = Rd(p, e)).pageX - f.relX, pageY: d.pageY + 5 });
            (l = g.ghost),
              (c = p.getBody()),
        ...
        (u = l),
        (i = function () {
          u.dragging && s.fire('dragend'), Hd(u);
        }),
        (s = e).on('mousedown', n),
        e.on('mousemove', r),
        e.on('mouseup', o),
        ...
        (n = e).on('drop', function (e) {
          var t =
            'undefined' != typeof e.clientX
              ...
              : null;
          (Md(t) || Md(n.dom.getContentEditableParent(t))) && e.preventDefault();
        });
    },
    Vd = function (e) {
      return I(
  ...
  var Id,
    Fd = function (o, i, a, e, u, t) {
      var n,
        ...
        r = function (e) {
          var t, n, r;
          for (r = Vd([e]), -1 === o && (r = r.reverse()), t = 0; t < r.length; t++)
            if (((n = r[t]), !a(n, s))) {
      ...
      return (
        (s = $t.last(t.getClientRects())) &&
          (r((n = t.getNode())),
          (function (e, t, n, r) {
            for (; (r = Cs(r, e, Ua, t)); ) if (n(r)) return;
          })(o, e, r, n)),
        c
      );
    },
    Ud = d(Fd, kd.Up, Ka, Xa),
    jd = d(Fd, kd.Down, Xa, Ka),
    qd = function (n) {
      return function (e) {
        return (t = n), e.line > t;
        var t;
    ...
    Jd = function (e, o) {
      return $t.reduce(e, function (e, t) {
        var n, r;
        return (
          (n = Math.min(Xd(e, o), Yd(e, o))),
          (r = Math.min(Xd(t, o), Yd(t, o))),
          Gd(o, t) ? t : Gd(o, e) ? e : r === n && Wd(t.node) ? t : r < n ? t : e
        );
      });
    },
    Qd = function (e, t, n, r) {
      for (; (r = Kd(r, e, Ua, t)); ) if (n(r)) return;
    },
    Zd = function (e, t, n) {
      var r,
        o,
        ...
        s,
        l,
        c = Vd(V(re(e.getElementsByTagName('*')), cs)),
        f = V(c, function (e) {
      ...
      return (r = Jd(f, t)) &&
        (r = Jd(
          ...
          (s = []).push((u = r)),
          Qd(kd.Up, a, d(l, Ka), u.node),
          Qd(kd.Down, a, d(l, Xa), u.node),
          s),
          t
        )) &&
        cs(r.node)
        ? ((i = t), { node: (o = r).node, before: Xd(o, i) < Yd(o, i) })
        : null;
    },
    eh = function (i, a, e) {
      return (
    ...
    th = _o.isContentEditableTrue,
    nh = _o.isContentEditableFalse,
    ...
    ih = function (e, t, n) {
      var r = Ts(1, e.getBody(), t),
        o = Eu.fromRangeStart(r),
        i = o.getNode();
      if (nh(i)) return rh(1, e, i, !o.isAtEnd(), !1);
      var a = o.getNode(!0);
      if (nh(a)) return rh(1, e, a, !1, !1);
      var u = e.dom.getParent(o.getNode(), function (e) {
        return nh(e) || th(e);
      });
      return nh(u) ? rh(1, e, u, !1, n) : null;
    },
    ah = function (e, t, n) {
    ...
    uh = function (t) {
      var e = Fi(function () {
        if (
          ...
          var e = ah(t, t.selection.getRng(), !1);
          t.selection.setRng(e);
        }
      }, 0);
      t.on('focus', function () {
    ...
    gh = function (e) {
      var t = e.container();
      return _o.isText(t) && 0 === t.data.length;
    },
    ph = function (t, n) {
      return function (e) {
        return T.from(Ns(t ? 0 : -1, e))
          .filter(n)
          .isSome();
      };
    },
    vh = function (e) {
      return 'IMG' === e.nodeName && 'block' === zr(or.fromDom(e), 'display');
    },
    bh = function (e) {
      return _o.isContentEditableFalse(e) && !_o.isBogusAll(e);
    },
    yh = ph(!0, vh),
    Ch = ph(!1, vh),
    wh = ph(!0, _o.isTable),
    ...
    Nh = ph(!0, bh),
    Eh = ph(!1, bh),
    zh = _o.isContentEditableTrue,
    Sh = _o.isContentEditableFalse,
    kh = function (e, t) {
      for (var n = e.getBody(); t && t !== n; ) {
        if (zh(t) || Sh(t)) return t;
        t = t.parentNode;
      }
      return null;
    },
    Th = function (m) {
      var g,
        ...
        b = function (e, t) {
          return (t = Ts(e, a, t)), -1 === e ? Eu.fromRangeStart(t) : Eu.fromRangeEnd(t);
        },
        t = function (e) {
        ...
        l = function (e, t) {
          ...
          if (e.collapsed) {
            if (!y(e))
              if (!1 === t) {
                if (((l = b(-1, e)), cs(l.getNode(!0)))) return v(-1, l.getNode(!0), !1, !1);
                if (cs(l.getNode())) return v(-1, l.getNode(), !l.isAtEnd(), !1);
              } else {
                if (((l = b(1, e)), cs(l.getNode()))) return v(1, l.getNode(), !l.isAtEnd(), !1);
                if (cs(l.getNode(!0))) return v(1, l.getNode(!0), !1, !1);
              }
            return null;
          }
          return (
                ...
                Sh(n)
                  ? ((c = f = n.cloneNode(!0)),
                    (s = m.fire('ObjectSelected', {
                      ...
                      ? null
                      : ((r = na(or.fromDom(m.getBody()), '#' + p).fold(
                          function () {
                            return d([]);
                          },
                          function (e) {
                        ...
                        c === f && he.ie
                          ? (r
                            ...
                            e.setEndAfter(c))
                          : (r.empty().append('\xa0').append(c).append('\xa0'),
                        ...
                        o.addRange(e),
                        L(Gi(or.fromDom(m.getBody()), '*[data-mce-selected]'), function (e) {
                          Er(e, 'data-mce-selected');
                        }),
        ...
        c = function () {
          g &&
            ...
            na(or.fromDom(m.getBody()), '#' + p).each(Vi),
            (g = null)),
            na(or.fromDom(m.getBody()), '#' + p).each(Vi),
            (g = null);
        },
      ...
      return (
        he.ceFalse &&
          (function () {
            m.on('mouseup', function (e) {
              var t = s();
              t.collapsed && Hf(m, e.clientX, e.clientY) && u(ih(m, t, !1));
            }),
              m.on('click', function (e) {
                var t;
                (t = kh(m, e.target)) &&
                  (Sh(t) && (e.preventDefault(), m.focus()),
                  zh(t) && m.dom.isChildOf(t, m.selection.getNode()) && c());
              }),
            ...
            var n,
              ...
              i = function (e, t) {
                ...
                return (
                  !(!o || !m.dom.isChildOf(o, i) || !1 !== Sh(kh(m, o))) ||
                  (o &&
                    ((n = o),
                    (r = i),
            ...
            (r = !1),
              ...
              n.on('touchend', function (e) {
                var t = kh(n, e.target);
                Sh(t) && (r || (e.preventDefault(), l(oh(n, t))));
              }),
              m.on('mousedown', function (e) {
                ...
                if (
                  ...
                  !1 !== Hf(m, e.clientX, e.clientY)
                )
                  if ((t = kh(m, n)))
                    Sh(t)
                      ? (e.preventDefault(), l(oh(m, t)))
                      : (c(),
                        (zh(t) && e.shiftKey) ||
                          eh(e.clientX, e.clientY, m.selection.getRng()) ||
                          (C(), m.selection.placeCaretAt(e.clientX, e.clientY)));
                  else if (!1 === cs(n)) {
                    c(), C();
                    var r = Zd(a, e.clientX, e.clientY);
              ...
              m.on('keypress', function (e) {
                sh.modifierPressed(e) ||
                  (e.keyCode, Sh(m.selection.getNode()) && e.preventDefault());
              }),
          ...
          })(),
        {
          ...
          showBlockCaretContainer: function (e) {
            e.hasAttribute('data-mce-caret') && (Ma(e), u(s()), m.selection.scrollIntoView(e[0]));
          },
          hideFakeCaret: C,
          destroy: function () {
            o.destroy(), (g = null);
    ...
    _h = function (e) {
      return V(K(re(e.childNodes), Bh), function (e) {
        return 0 < e.length;
      });
    },
    Hh = function (e, t) {
    ...
    Fh = function (e) {
      var t = or.fromTag(
        'body',
        Ph.get().getOrThunk(function () {
          var e = j.document.implementation.createHTMLDocument('undo');
          return Ph.set(T.some(e)), e;
        })
      );
      return ga(t, Ih(e)), L(Gi(t, '*[data-mce-bogus]'), Ii), t.dom().innerHTML;
    },
    Uh = function (n) {
      var e, t, r;
      return (
        ...
        -1 !==
        (t = (r = J(e, function (e) {
          var t = Wl.trimInternal(n.serializer, e);
          return 0 < t.length ? [t] : [];
        })).join('')).indexOf('</iframe>')
          ? Lh(r)
          : Vh(t)
      ...
      (o = {
        ...
        add: function (e, t) {
          var n,
            ...
            o,
            i = u.settings;
          if (((o = Uh(u)), (e = e || {}), (e = Gt.extend(e, o)), !1 === f() || u.removed))
            return null;
          if (
            ((r = c[l]),
            u
        ...
        undo: function () {
          ...
          return (
            ...
            0 < l && ((e = c[--l]), jh(u, e, !0), d(!0), u.fire('undo', { level: e })),
            e
          );
        },
        redo: function () {
          var e;
          return (
            l < c.length - 1 && ((e = c[++l]), jh(u, e, !1), d(!0), u.fire('redo', { level: e })), e
          );
        },
        clear: function () {
        ...
        hasUndo: function () {
          return 0 < l || (o.typing && c[0] && !qh(Uh(u), c[0]));
        },
        hasRedo: function () {
  ...
  var Wh,
    ...
    Xh = function (e) {
      ...
      t.length === n.length && L(n, Vi);
    },
    Yh = function (e) {
      Li(e), Hi(e, or.fromHtml('<br data-mce-bogus="1">'));
    },
    Gh = function (n) {
    ...
    Zh = function (t, e, n, r) {
      ...
      return (
        ...
        ((e = t.dom.getParent(e, function (e) {
          return !!Qh(t, e, n) || e.parentNode === o || !!nm(t, e, n, r, !0);
        })),
        nm(t, e, n, r))
      );
    },
        ...
        if ('undefined' == typeof l.length) {
          for (a in l)
            if (l.hasOwnProperty(a)) {
              if (
                ((u = 'attributes' === r ? e.getAttrib(t, a) : gl.getStyle(e, t, a)),
                o && !u && !n.exact)
              )
                return;
              if ((!o || n.exact) && !Jh(u, gl.normalizeStyleValue(e, gl.replaceVars(l[a], i), a)))
                return;
            }
        } else
          for (s = 0; s < l.length; s++)
            if ('attributes' === r ? e.getAttrib(t, l[s]) : gl.getStyle(e, t, l[s])) return n;
      return n;
    },
    nm = function (e, t, n, r, o) {
      ...
      if (l && t)
        for (a = 0; a < l.length; a++)
          if (
            ((i = l[a]),
            em(e.dom, t, i) && tm(c, t, i, 'attributes', o, r) && tm(c, t, i, 'styles', o, r))
          ) {
            if ((s = i.classes))
    ...
    rm = {
      ...
      match: function (e, t, n, r) {
        ...
        return r
          ...
          : ((r = e.selection.getNode()),
            !!Zh(e, r, t, n) || !((o = e.selection.getStart()) === r || !Zh(e, o, t, n)));
      },
        ...
        return (
          ...
          r.dom.getParent(
            ...
            function (e) {
              var t, n;
              for (t = 0; t < o.length; t++)
                (n = o[t]), !u[n] && nm(r, e, n, i) && ((u[n] = !0), a.push(n));
            },
            r.dom.getRoot()
          ),
          a
      ...
      canApply: function (e, t) {
        var n,
          ...
          s = e.dom;
        if (u)
          for (n = e.selection.getStart(), r = gl.getParents(s, n), i = u.length - 1; 0 <= i; i--) {
            if (!(a = u[i].selector) || u[i].defaultBlock) return !0;
            for (o = r.length - 1; 0 <= o; o--) if (s.is(r[o], a)) return !0;
          }
        return !1;
      },
      matchesUnInheritedFormatSelector: Qh,
    },
    om = function (e, t) {
      ...
      return (
        t === r && _o.isText(t)
          ? 0 < n &&
            ...
            ((t = (r = om(t, n)).previousSibling),
            n < o
              ? ((t = r = om(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0))
              : (o = 0))
          : (_o.isText(t) && 0 < n && n < t.nodeValue.length && ((t = om(t, n)), (n = 0)),
            _o.isText(r) &&
              0 < o &&
              o < r.nodeValue.length &&
              (o = (r = om(r, o).previousSibling).nodeValue.length)),
    ...
    sm = function (e, t) {
      var n,
        ...
        i = or.fromDom(e),
        a = or.fromDom(t);
      return (n = a), (r = 'pre,code'), (o = d(Pr, i)), ta(n, r, o).isSome();
    },
    lm = function (e, t) {
      return (
        (Ia(t) &&
          !1 ===
            ((r = e), (o = t), _o.isText(o) && /^[ \t\r\n]*$/.test(o.data) && !1 === sm(r, o))) ||
        ((n = t), _o.isElement(n) && 'A' === n.nodeName && n.hasAttribute('name')) ||
        cm(t)
      );
      var n, r, o;
    },
    cm = _o.hasAttribute('data-mce-bookmark'),
    fm = _o.hasAttribute('data-mce-bogus'),
    dm = _o.hasAttributeValue('data-mce-bogus', 'all'),
    hm = function (e) {
      return (function (e) {
        var t,
          n,
    ...
    mm = function (e, t) {
      return (
        ...
        (o = (n = t).container()),
        (i = n.offset()),
        !1 === Eu.isTextPosition(n) && o === r.parentNode && i > Eu.before(r).offset()
          ? Eu(t.container(), t.offset() - 1)
          : t
      );
      var n, r, o, i;
    },
    gm = function (e) {
      return Ia(e.previousSibling)
        ? T.some(((t = e.previousSibling), _o.isText(t) ? Eu(t, t.data.length) : Eu.after(t)))
        : e.previousSibling
          ? tl.lastPositionIn(e.previousSibling)
          : T.none();
      var t;
    },
    pm = function (e) {
      return Ia(e.nextSibling)
        ? T.some(((t = e.nextSibling), _o.isText(t) ? Eu(t, 0) : Eu.before(t)))
        : e.nextSibling
          ? tl.firstPositionIn(e.nextSibling)
          : T.none();
      var t;
    },
    vm = function (r, o) {
      return gm(o)
        ...
        .orThunk(function () {
          return (
            (e = r),
            (t = o),
            (n = Eu.before(t.previousSibling ? t.previousSibling : t.parentNode)),
            tl.prevPosition(e, n).fold(function () {
              return tl.nextPosition(e, Eu.after(t));
            }, T.some)
          );
          var e, t, n;
        });
      ...
      return pm(r)
        ...
        .orThunk(function () {
          return (
            (e = n),
            (t = r),
            tl.nextPosition(e, Eu.after(t)).fold(function () {
              return tl.prevPosition(e, Eu.before(t));
            }, T.some)
          );
          var e, t;
        });
    ...
    ym = function (e, t, n) {
      return ((r = e), (o = t), (i = n), r ? bm(o, i) : vm(o, i)).map(d(mm, n));
      var r, o, i;
    },
    Cm = function (t, n, e) {
      e.fold(
    ...
    xm = function (e) {
      if (hm(e)) {
        ...
        return Li(e), Hi(e, t), T.some(Eu.before(t.dom()));
      }
      return T.none();
    },
    Nm = function (e, t, c) {
    ...
    Em = function (t, n, e, r) {
      ...
      var o,
        ...
        s = Nm(e, a, ((i = e), yr(t.schema.getTextInlineElements(), sr(i))));
    ...
    Am = function (e) {
      ...
      return (
        xr(t, { id: Sm, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }),
        e && Hi(t, or.fromText(zm)),
        t
      );
    },
    Rm = function (e, t, n) {
    ...
    Mm = function (e, t, n) {
      ...
      var r = e.dom,
        o = e.selection;
      if (t) Rm(e, t, n);
      else if (!(t = Xu(e.getBody(), o.getStart()))) for (; (t = r.get(Sm)); ) Rm(e, t, !1);
    },
    Dm = function (e, t, n) {
      var r = e.dom,
        o = r.getParent(n, d(gl.isTextBlock, e));
      o && r.isEmpty(o)
        ? n.parentNode.replaceChild(t, n)
        : (Xh(or.fromDom(n)), r.isEmpty(n) ? n.parentNode.replaceChild(t, n) : r.insertAfter(t, n));
    },
    Bm = function (e, t) {
    ...
    Om = function (e, t) {
      var n,
        ...
        o =
          ...
          r);
      return Bm(o, o.ownerDocument.createTextNode(zm));
    },
    _m = function (i) {
      i.on('mouseup keydown', function (e) {
        ...
        (t = i),
          ...
          (8 !== n && 46 !== n) ||
            ...
            Mm(t, Xu(o, r.getStart())),
          (37 !== n && 39 !== n) || Mm(t, Xu(o, r.getStart()));
      });
    },
    Hm = function (e, t) {
      return (
  ...
  var Im = function (e, t) {
    ...
    Km = function (e, t, n) {
      ...
      return (
        ...
        _o.isText(r) && n && o >= r.nodeValue.length && (r = new uo(r, e.getBody()).next() || r),
        _o.isText(r) && !n && 0 === o && (r = new uo(r, e.getBody()).prev() || r),
        r
      );
    },
    Xm = function (e, t, n, r) {
    ...
    Ym = function (e, t, n, r, o) {
      var i = or.fromDom(t),
        ...
        u = n ? qr(i) : jr(i);
      return Pi(a, u), n ? (Bi(i, a), _i(a, i)) : (Oi(i, a), Hi(a, i)), a.dom();
    },
    Gm = function (e, t, n, r) {
      return !(t = gl.getNonWhiteSpaceSibling(t, n, r)) || 'BR' === t.nodeName || e.isBlock(t);
    },
    Jm = function (e, n, r, o, i) {
      var t,
        a,
        u,
        s,
      ...
      if (
        ...
        !(
          $m((c = o), (f = n).inline) ||
          $m(c, f.block) ||
          (f.selector ? _o.isElement(c) && l.is(c, f.selector) : void 0) ||
      ...
      if ('all' !== n.remove)
        for (
          qm(n.styles, function (e, t) {
            (e = gl.normalizeStyleValue(y, gl.replaceVars(e, r), t)),
              'number' == typeof t && ((t = e), (i = 0)),
              (n.remove_similar || !i || $m(gl.getStyle(y, i, t), e)) && y.setStyle(o, t, ''),
              (u = 1);
          }),
            u &&
              '' === y.getAttrib(o, 'style') &&
              (o.removeAttribute('style'), o.removeAttribute('data-mce-style')),
            qm(n.attributes, function (e, t) {
              var n;
              if (
                ((e = gl.replaceVars(e, r)),
                'number' == typeof t && ((t = e), (i = 0)),
                !i || $m(y.getAttrib(i, t), e))
              ) {
                if (
                  'class' === t &&
                  (e = y.getAttrib(o, t)) &&
                  ((n = ''),
                  qm(e.split(/\s+/), function (e) {
                    /mce\-\w+/.test(e) && (n += (n ? ' ' : '') + e);
                  }),
                  n)
                )
                ...
                'class' === t && o.removeAttribute('className'),
                  jm.test(t) && o.removeAttribute('data-mce-' + t),
                  o.removeAttribute(t);
              }
            }),
            qm(n.classes, function (e) {
              (e = gl.replaceVars(e, r)), (i && !y.hasClass(i, e)) || y.removeClass(o, e);
            }),
            a = y.getAttribs(o),
            t = 0;
          t < a.length;
      ...
      return 'none' !== n.remove
        ? ((d = e),
          ...
          m.block &&
            (b
              ? p === v.getRoot() &&
                ((m.list_block && $m(h, m.list_block)) ||
                  qm(Gt.grep(h.childNodes), function (e) {
                    gl.isValid(d, b, e.nodeName.toLowerCase())
                      ? g
                        ? g.appendChild(e)
                        : ((g = Xm(v, e, b)), v.setAttribs(g, d.settings.forced_root_block_attrs))
                      : (g = 0);
                  }))
              : v.isBlock(h) &&
                !v.isBlock(p) &&
                (Gm(v, h, !1) ||
                  Gm(v, h.firstChild, !0, 1) ||
                  h.insertBefore(v.create('br'), h.firstChild),
                Gm(v, h, !0) || Gm(v, h.lastChild, !1, 1) || h.appendChild(v.create('br')))),
          (m.selector && m.inline && !$m(m.inline, h)) || v.remove(h, 1),
          !0)
        : void 0;
    },
    Qm = Jm,
    Zm = function (s, l, c, e, f) {
      var t,
        n,
        d = s.formatter.get(l),
        h = d[0],
        ...
        i = function (e) {
          var n,
            ...
            u =
              ...
              (o = c),
              (i = f),
              qm(gl.getParents(n.dom, t.parentNode).reverse(), function (e) {
                var t;
                a ||
                  '_start' === e.id ||
                  '_end' === e.id ||
                  ((t = rm.matchNode(n, e, r, o, i)) && !1 !== t.split && (a = e));
              }),
              a);
        ...
        m = function (e) {
          ...
          if (
            ...
            for (n = 0, r = d.length; n < r && !Jm(s, d[n], c, e, e); n++);
          if (h.deep && t.length) {
          ...
          if (((e = kl(s, e, d, !0)), h.split)) {
            if (((e = im(e)), (t = Km(s, e, !0)) !== (n = Km(s, e)))) {
              if (
                ...
                return (
                  i(Ym(u, o, !0, 'span', { id: '_start', 'data-mce-type': 'bookmark' })), void g(!0)
                );
              }
              if (Wm(u, n, t))
                return (
                  (o = T.from(n.lastChild).getOr(n)),
                  i(Ym(u, o, !1, 'span', { id: '_end', 'data-mce-type': 'bookmark' })),
                  void g(!1)
                );
              (t = Xm(u, t, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
                (n = Xm(u, n, 'span', { id: '_end', 'data-mce-type': 'bookmark' })),
                i(t),
                i(n),
                (t = g(!0)),
                (n = g());
            ...
            qm(e, function (e) {
              m(e),
                _o.isElement(e) &&
                  ...
                  e.parentNode &&
                  'underline' === gl.getTextDecoration(u, e.parentNode) &&
                  Jm(
                    s,
                    {
                      deep: !1,
      ...
      if (e) e.nodeType ? ((n = u.createRng()).setStartBefore(e), n.setEndAfter(e), o(n)) : o(e);
        ...
        !u.select('td[data-mce-selected],th[data-mce-selected]').length
          ? (function (e, t, n, r) {
              ...
              if (l)
                if (u) {
                  ...
                  (g = im(g)), e.formatter.remove(t, n, g), d.moveToBookmark(a);
                } else {
                  c = Xu(e.getBody(), l);
                  var p = Am(!1).dom(),
                    v = Om(h, p);
          ...
          : ((t = $u.getPersistentBookmark(s.selection, !0)),
            o(r.getRng()),
            r.moveToBookmark(t),
            h.inline && rm.match(s, l, c, r.getStart()) && gl.moveStart(u, r, r.getRng()),
            s.nodeChanged());
      else {
        e = r.getNode();
        for (
          var p = 0, v = d.length;
          p < v && (!d[p].ceFalseOverride || !Jm(s, d[p], c, e, e));
          p++
        );
      }
    },
    eg = Gt.each,
    tg = function (e) {
      return e && 1 === e.nodeType && !fl(e) && !Ku(e) && !_o.isBogus(e);
    },
    ng = function (e, t) {
      var n;
      for (n = e; n; n = n[t]) {
        if (3 === n.nodeType && 0 !== n.nodeValue.length) return e;
        if (1 === n.nodeType && !fl(n)) return n;
      }
      return e;
    },
    rg = function (e, t, n) {
    ...
    og = function (e, t, n) {
      eg(e.childNodes, function (e) {
        tg(e) && (t(e) && n(e), e.hasChildNodes() && og(e, t, n));
      });
    },
    ig = function (n, e) {
      return d(function (e, t) {
        return !(!t || !gl.getStyle(n, t, e));
      }, e);
    },
    ag = function (r, e, t) {
      return d(
    ...
    sg = function (e, t) {
      ...
      1 === t.nodeType &&
        ...
        ((n = gl.getTextDecoration(e, t.parentNode)),
    ...
    lg = function (n, e, r, o) {
      eg(e, function (t) {
        eg(n.dom.select(t.inline, o), function (e) {
          tg(e) && Qm(n, t, r, e, t.exact ? e : null);
        }),
          (function (r, e, t) {
            if (e.clear_child_styles) {
              var n = e.links ? '*:not(a)' : '*';
              eg(r.select(n, t), function (n) {
                tg(n) &&
                  eg(e.styles, function (e, t) {
                    r.setStyle(n, t, '');
                  });
              });
            }
    ...
    cg = function (e, t, n, r) {
      (t.styles.color || t.styles.textDecoration) && (Gt.walk(r, d(sg, e), 'childNodes'), sg(e, r));
    },
    fg = function (e, t, n, r) {
      t.styles &&
        ...
        og(
          r,
          ig(e, 'fontSize'),
          ag(e, 'backgroundColor', gl.replaceVars(t.styles.backgroundColor, n))
        );
    },
    dg = function (e, t, n, r) {
      ('sub' !== t.inline && 'sup' !== t.inline) ||
        (og(r, ig(e, 'fontSize'), ag(e, 'fontSize', '')),
        e.remove(e.select('sup' === t.inline ? 'sub' : 'sup', r), !0));
    },
    hg = function (e, t, n, r) {
      r &&
        !1 !== t.merge_siblings &&
        ((r = rg(e, gl.getNonWhiteSpaceSibling(r), r)),
        (r = rg(e, r, gl.getNonWhiteSpaceSibling(r, !0))));
    },
    mg = function (t, n, r, o, i) {
      (rm.matchNode(t, i.parentNode, r, o) && Qm(t, n, o, i)) ||
        (n.merge_with_parents &&
          t.dom.getParent(i.parentNode, function (e) {
            if (rm.matchNode(t, e, r, o)) return Qm(t, n, o, i), !0;
          }));
    },
    gg = function (a) {
      var u = Eu.fromRangeStart(a),
        s = Eu.fromRangeEnd(a),
        l = a.commonAncestorContainer;
      return tl
        .fromPosition(!1, l, s)
        .map(function (e) {
          return !xs(u, s, l) && xs(u, e, l)
            ? ((t = u.container()),
              (n = u.offset()),
              (r = e.container()),
              (o = e.offset()),
        ...
        y = function (n, e) {
          if (((e = e || b), n)) {
            if (
              ...
              vg(e.styles, function (e, t) {
                i.setStyle(n, t, gl.replaceVars(e, p));
              }),
              e.styles)
            ) {
            ...
            vg(e.attributes, function (e, t) {
              i.setAttrib(n, t, gl.replaceVars(e, p));
            }),
              vg(e.classes, function (e) {
                (e = gl.replaceVars(e, p)), i.hasClass(n, e) || i.addClass(n, e);
              });
          }
        },
        C = function (e, t) {
        ...
        a = function (s, e, t, l) {
          ...
          (c = b.inline || b.block),
            ...
            Al(s, e, function (e) {
              var a,
                u = function (e) {
                  ...
                  if (b.wrapper && rm.matchNode(m, e, g, p)) a = 0;
                  else {
                    if (
                      h &&
                      !r &&
                    ...
                    (b.inline && s.isBlock(e))
                      ? ((a = 0), vg(Gt.grep(e.childNodes), u), r && (h = o), (a = 0))
            ...
            !0 === b.links &&
              vg(d, function (e) {
                var t = function (e) {
                  'A' === e.nodeName && y(e, b), vg(Gt.grep(e.childNodes), t);
                };
                t(e);
              }),
            vg(d, function (e) {
              var t,
                ...
                a = function (e) {
                  var n = !1;
                  return (
                    vg(e.childNodes, function (e) {
                      if ((t = e) && 1 === t.nodeType && !fl(t) && !Ku(t) && !_o.isBogus(t))
                        return (n = e), !1;
                      var t;
                    }),
                    n
      ...
      if ('false' !== i.getContentEditable(n.getNode())) {
        if (b) {
          if (r)
            r.nodeType
              ? C(v, r) ||
                ((t = i.createRng()).setStartBefore(r), t.setEndAfter(r), a(i, kl(m, t, v), 0, !0))
              : a(i, r, 0, !0);
            ...
            !(function (e, t, n) {
              ...
              (a = (r = l.getRng(!0)).startOffset),
                ...
                (o = Xu(e.getBody(), l.getStart())) && (i = Tm(o));
              var c,
                f,
                d = /[^\s\u00a0\u00ad\u200b\ufeff]/;
            ...
            m.settings.forced_root_block ||
              ...
              bg(m, v[0].defaultBlock),
              m.selection.setRng(pg(m.selection.getRng())),
              (e = $u.getPersistentBookmark(m.selection, !0)),
              a(i, kl(m, n.getRng(), v)),
              b.styles && cg(i, b, p, u),
              n.moveToBookmark(e),
              gl.moveStart(i, n, n.getRng()),
              m.nodeChanged();
          }
          Im(g, m);
        }
    ...
    Cg = function (r, e, t, n) {
      var o = dr(t.get()),
        i = {},
        a = {},
        u = V(gl.getParents(r.dom, e), function (e) {
          return 1 === e.nodeType && !e.getAttribute('data-mce-bogus');
        });
      mr(n, function (e, n) {
        Gt.each(u, function (t) {
          return r.formatter.matchNode(t, n, {}, e.similar)
            ? (-1 === o.indexOf(n) &&
              ...
              (a[n] = e.callbacks),
              !1)
            : !rm.matchesUnInheritedFormatSelector(r, t, n) && void 0;
        });
      });
      var s = wg(t.get(), a, e, u);
      t.set(Si({}, i, s));
    },
    wg = function (e, n, r, o) {
      ...
      return (
        null === o.get() &&
          ...
          r.on('NodeChange', function (e) {
            Cg(r, e.element, u, n.get());
          })),
        (l = i),
        (c = a),
        (f = t),
        (d = (s = o).get()),
        L(l.split(','), function (e) {
        ...
        s.set(d),
        {
          unbind: function () {
            return (
              ...
              (n = a),
              (r = (e = o).get()),
              L(t.split(','), function (e) {
                (r[e].callbacks = V(r[e].callbacks, function (e) {
                  return e !== n;
                })),
    ...
    Sg = function (e, t) {
      var n,
        ...
        m = function (e) {
          ...
          return (
            ...
            (t = zg.create(o.name)),
            (n = t),
            (r = o).classes.length && zg.addClass(n, r.classes.join(' ')),
            zg.setAttribs(n, r.attrs),
            t
          );
        },
        g = function (n, e, t) {
          ...
          return (
            ...
            t &&
              (r || (r = zg.create('div')).appendChild(n),
      ...
      return e && e.length
        ? ((o = e[0]),
          (n = m(o)),
          (r = zg.create('div')).appendChild(g(n, e.slice(1), o.siblings)),
          r)
        : '';
    },
    kg = function (e) {
    ...
    Ag = function (n, e) {
      ...
      return 'preview' in e && !1 === (u = e.preview)
        ...
        : ((t = e.block || e.inline || 'span'),
          (r = (i = Tg(e.selector)).length
            ? (i[0].name || (i[0].name = t), (t = e.selector), Sg(i, n))
            : Sg([t], n)),
          (o = zg.select(t, r)[0] || r.firstChild),
          Eg(e.styles, function (e, t) {
            (e = l(e)) && zg.setStyle(o, t, e);
          }),
          Eg(e.attributes, function (e, t) {
            (e = l(e)) && zg.setAttrib(o, t, e);
          }),
          Eg(e.classes, function (e) {
            (e = l(e)), zg.hasClass(o, e) || zg.addClass(o, e);
          }),
          n.fire('PreviewFormats'),
          zg.setStyles(r, { position: 'absolute', left: -65535 }),
          n.getBody().appendChild(r),
          (a = zg.getStyle(n.getBody(), 'fontSize', !0)),
          (a = /px$/.test(a) ? parseInt(a, 10) : 0),
          Eg(u.split(' '), function (e) {
            var t = zg.getStyle(o, e, !0);
            if (
              !(
                ('background-color' === e &&
                  /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) &&
                  ((t = zg.getStyle(n.getBody(), e, !0)),
                  '#ffffff' === zg.toHex(t).toLowerCase())) ||
                ('color' === e && '#000000' === zg.toHex(t).toLowerCase())
              )
            ) {
    ...
    Rg = function (e, t, n, r, o) {
      var i = t.get(n);
      !rm.match(e, n, r, o) || ('toggle' in i[0] && !i[0].toggle)
        ? yg.applyFormat(e, n, r, o)
        : Zm(e, n, r, o);
    },
    Mg = function (e) {
  ...
  var Bg,
    ...
    _g =
      ...
      function () {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
          var o = e[r];
          for (var i in o) Og.call(o, i) && (n[i] = Bg(n[i], o[i]));
        }
        return n;
      }),
    Hg = {
        ...
        t.addAttributeFilter('data-mce-tabindex', function (e, t) {
          ...
          t.addAttributeFilter('data-mce-type', function (e, t, n) {
            for (var r, o = e.length; o--; )
              'bookmark' !== (r = e[o]).attributes.map['data-mce-type'] ||
                n.cleanup ||
                (T.from(r.firstChild).exists(function (e) {
                  return !va(e.value);
                })
                  ? r.unwrap()
                  : r.remove());
          ...
          t.addNodeFilter('noscript', function (e) {
            for (var t, n = e.length; n--; )
              (t = e[n].firstChild) && (t.value = Yo.decode(t.value));
          }),
    ...
    Vg = function (e, t) {
      var n,
        r = si();
      t.convert_fonts_to_spans && Lg(e, r, Gt.explode(t.font_size_legacy_values)),
        (n = r),
    ...
    Ig = {
      register: function (e, t) {
        t.inline_styles && Vg(e, t);
      },
    },
    Fg = function (e, t, n, r) {
      (e.padd_empty_with_br || t.insert) && n[r.name]
        ? (r.empty().append(new Il('br', 1)).shortEnded = !0)
        : (r.empty().append(new Il('#text', 3)).value = '\xa0');
    },
    Ug = function (e) {
      return jg(e, '#text') && '\xa0' === e.firstChild.value;
    },
    jg = function (e, t) {
            ...
            if (((i = (o = e[r]).parent), d[o.parent.name] && o === i.lastChild)) {
              ...
              o &&
                ...
                qg(p, h, m, i) &&
                  ...
                  (l.removeEmpty ? i.remove() : l.paddEmpty && Fg(g, n, d, i)));
            } else {
              for (a = o; i && i.firstChild === a && i.lastChild === a && !d[(a = i).name]; )
                i = i.parent;
              a === i &&
                !0 !== g.padd_empty_with_br &&
                (((c = new Il('#text', 3)).value = '\xa0'), o.replace(c));
            }
        }),
  ...
  function Jg(T, A) {
    ...
    var O = function (e) {
        var t, n, r;
        (n = e.name) in R && ((r = D[n]) ? r.push(e) : (D[n] = [e])), (t = M.length);
        for (; t--; )
          (n = M[t].name) in e.attributes.map && ((r = B[n]) ? r.push(e) : (B[n] = [e]));
        return e;
      },
      e = {
        schema: A,
        addAttributeFilter: function (e, n) {
          Xg(Yg(e), function (e) {
            var t;
            for (t = 0; t < M.length; t++) if (M[t].name === e) return void M[t].callbacks.push(n);
            M.push({ name: e, callbacks: [n] });
          });
        },
        ...
        parse: function (e, a) {
          ...
          (a = a || {}),
            (D = {}),
            (B = {}),
            (c = Gg(Kg('script,style,head,html,body,title,meta,param'), A.getBlockElements()));
          var m,
          ...
          var z = function (e, t) {
              var n,
                r = new Il(e, t);
              return e in R && ((n = D[e]) ? n.push(r) : (D[e] = [r])), r;
            },
            S = function (e) {
              var t,
                n,
          ...
          t = ql(
            {
              ...
              text: function (e, t) {
                var n;
                f || ((e = e.replace(N, ' ')), $g(d.lastChild, c) && (e = e.replace(w, ''))),
              ...
              start: function (e, t, n) {
                ...
                if ((i = v ? A.getElementRule(e) : {})) {
                  for (
                    ...
                    (a = M[o].name) in t.map && ((s = B[a]) ? s.push(r) : (B[a] = [r]));
                ...
                if ((n = v ? A.getElementRule(e) : {})) {
                  ...
                  if (
                    (f && C[e] && (f = !1),
                    n.removeEmpty && qg(A, g, C, d) && !d.attributes.map.name && !d.attr('id'))
                  )
                    return (
                      (i = d.parent), c[d.name] ? d.empty().remove() : d.unwrap(), void (d = i)
                    );
                  n.paddEmpty && (Ug(d) || qg(A, g, C, d)) && Fg(T, a, c, d), (d = d.parent);
                }
              },
            },
            A
          );
          var k = (d = new Il(a.context || T.root_name, 11));
          if (
            (t.parse(e),
            v &&
              h.length &&
              (a.context
                ...
                : (function (e) {
                    ...
                    for (
                      d = Kg('tr,td,th,tbody,thead,tfoot,table'),
                      ...
                      if ((n = e[t]).parent && !n.fixed)
                        if (h[n.name] && 'li' === n.parent.name) {
                          ...
                          if (r && 1 < o.length) {
                            for (
                              o.reverse(), i = a = O(o[0].clone()), l = 0;
                              l < o.length - 1;
                              l++
                            ) {
                              for (
                                A.isValidChild(a.name, o[l].name)
                                  ? ((u = O(o[l].clone())), a.append(u))
                                  : (u = a),
                                  s = o[l].firstChild;
                                s && s !== o[l + 1];
                            ...
                            qg(A, c, f, i)
                              ...
                              (r = o[0]),
                              (qg(A, c, f, r) || jg(r, 'br')) && r.empty().remove();
                          } else if (n.parent) {
                            if ('li' === n.name) {
            ...
            for (l in D) {
              for (s = R[l], i = (n = D[l]).length; i--; ) n[i].parent || n.splice(i, 1);
    ...
    return Wg(e, T), Ig.register(e, T), e;
  }
  var Qg = function (e, t, n) {
    ...
    Zg = function (e, t, n) {
      ...
      return n.selection || No(or.fromDom(t)) ? r : Gt.trim(r);
    },
    ep = function (e, t, n) {
      var r = n.selection ? _g({ forced_root_block: !1 }, n) : n,
        o = e.parse(t, r);
      return Hg.trimTrailingBr(o), o;
    },
    tp = function (e, t, n, r, o) {
      var i,
        ...
        u,
        s,
        l = ((i = r), Sc(t, n).serialize(i));
      return (a = e), (s = l), (u = o).no_events || !a ? s : sf(a, _g(u, { content: s })).content;
    };
  function np(e, t) {
      ...
      return (
        ...
        Hg.register(c, a, s),
        {
          ...
          serialize: function (e, t) {
            var n = _g({ format: 'html' }, t || {}),
              r = Pg.process(u, e, n),
              o = Zg(s, r, n),
              i = ep(c, o, n);
            return 'tree' === n.format ? i : tp(u, a, l, i, n);
          },
          addRules: function (e) {
  ...
  function rp(e) {
    return { getBookmark: d(ll, e), moveToBookmark: d(cl, e) };
  }
  (rp || (rp = {})).isBookmarkNode = fl;
  var op,
    ip,
    ap = rp,
    up = _o.isContentEditableFalse,
    sp = _o.isContentEditableTrue,
    lp = function (r, a) {
      var u,
        s,
        l,
      ...
      var R = function (e) {
        ...
        B = function (e) {
          ...
          (t = e.screenX - d),
            ...
            (R(u) && !1 !== a.settings.resize_img_proportional
              ? !sh.modifierPressed(e)
              : sh.modifierPressed(e) || (R(u) && f[2] * f[3] != 0)) &&
              (k(t) > k(n) ? ((C = T(y * b)), (y = T(C / b))) : ((y = T(C / b)), (C = T(y * b)))),
            N.setStyles(M(s), { width: y, height: C }),
        ...
        O = function () {
          ...
          e('width', y),
            ...
            N.unbind(z, 'mouseup', O),
            S !== z && (N.unbind(S, 'mousemove', B), N.unbind(S, 'mouseup', O)),
            N.remove(s),
            N.remove(l),
            o(u),
            hf(a, u, y, C),
                  ...
                  (t = N.get('mceResizeHandle' + e)) && N.remove(t),
                    ...
                    N.bind(t, 'mousedown', function (e) {
                      ...
                      e.stopImmediatePropagation(),
                        ...
                        N.bind(z, 'mouseup', O),
                        S !== z && (N.bind(S, 'mousemove', B), N.bind(S, 'mouseup', O)),
                        (l = N.add(
                          A,
                          'div',
    ...
    dp = function (d, e) {
      te(wu.fromRangeStart(e).getClientRects()).each(function (e) {
        var t,
          n,
          r,
          o,
    ...
    vp = Tr('element', 'width', 'rows'),
    bp = Tr('element', 'cells'),
    yp = Tr('x', 'y'),
    Cp = function (e, t) {
      var n = parseInt(Nr(e, t), 10);
      return isNaN(n) ? 1 : n;
    },
    wp = function (e) {
      return I(
    ...
    xp = function (e, t) {
      for (var n = e.rows(), r = 0; r < n.length; r++)
        for (var o = n[r].cells(), i = 0; i < o.length; i++)
          if (Pr(o[i], t)) return T.some(yp(i, r));
      return T.none();
    },
    ...
    Ep = function (e) {
      var o = vp(ha(e), 0, []);
      return (
        L(Gi(e, 'tr'), function (n, r) {
          L(Gi(n, 'td,th'), function (e, t) {
            !(function (e, t, n, r, o) {
              for (
                var i = Cp(o, 'rowspan'), a = Cp(o, 'colspan'), u = e.rows(), s = n;
                s < n + i;
                s++
              ) {
                u[s] || (u[s] = bp(ma(r), []));
                for (var l = t; l < t + a; l++) u[s].cells()[l] = s === n && l === t ? o : ha(o);
              }
            })(
              o,
              (function (e, t, n) {
    ...
    Sp = function (c, e, t) {
      return xp(c, e).bind(function (l) {
        return xp(c, t).map(function (e) {
          return (
            (t = c),
            (r = e),
            (o = (n = l).x()),
            ...
            (a = r.x()),
            (u = r.y()),
            (s = i < u ? Np(t, o, i, a, u) : Np(t, o, u, a, i)),
            vp(t.element(), wp(s), s)
          );
          var t, n, r, o, i, a, u, s;
        });
    ...
    Op = Bp,
    _p = function (e) {
      return Bp(Tp(e.selection.getSel()), or.fromDom(e.getBody()));
    },
    Hp = function (n, t) {
      return F(n, function (e) {
        return 'li' === sr(e) && Nd(e, t);
      }).fold($([]), function (e) {
        return ((t = n),
        F(t, function (e) {
    ...
    Ip = function (e, o) {
      return ((t = e), (n = o[0]), ta(n, 'table', d(Pr, t)))
        .bind(function (e) {
          var t = o[0],
            n = o[o.length - 1],
            r = Ep(e);
          return Sp(r, t, n).map(function (e) {
            return pp([zp(e)]);
          });
        })
        .getOrThunk(Lp);
    ...
    Fp = function (e, t) {
      ...
      return 0 < o.length
        ? Ip(e, o)
        : ((n = e), 0 < (r = t).length && r[0].collapsed ? Lp() : Vp(n, r[0]));
    },
    Up = function (e, t) {
      if (
        (void 0 === t && (t = {}),
      ...
      var n,
        ...
        c =
          ...
          (s = gp(n, Tp(u))),
          (o = r.contextual ? Fp(or.fromDom(n.getBody()), s).dom() : i.cloneContents()) &&
            a.appendChild(o),
    ...
    Wp = function (e, t, n) {
      for (
        var r = new uo(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot());
        (t = r[n ? 'prev' : 'next']());
    ...
    Kp = function (e, t, n, r, o) {
      ...
      if (((u = e.getParent(o.parentNode, e.isBlock) || f), r && _o.isBr(o) && t && e.isEmpty(u)))
        return T.some(wu(o.parentNode, e.nodeIndex(o)));
      for (i = new uo(o, u); (s = i[r ? 'prev' : 'next']()); ) {
        if (
          'false' === e.getContentEditableParent(s) ||
          ((c = f), Ea((l = s)) && !1 === jp(l, c, Ku))
        )
          return T.none();
        if (_o.isText(s) && 0 < s.nodeValue.length)
          return !1 === qp(s, f, 'A') ? T.some(wu(s, r ? s.nodeValue.length : 0)) : T.none();
        if (e.isBlock(s) || d[s.nodeName.toLowerCase()]) return T.none();
        a = s;
      }
      return n && a ? T.some(wu(a, 0)) : T.none();
    },
    Xp = function (e, t, n, r) {
      var o,
        i,
      ...
      if (
        ...
        (c = _o.isElement(o) && i === o.childNodes.length),
        ...
        return T.none();
      if (
        (_o.isElement(o) && i > o.childNodes.length - 1 && (l = !1),
        _o.isDocument(o) && ((o = m), (i = 0)),
        o === m)
      ) {
        if (l && (u = o.childNodes[0 < i ? i - 1 : 0])) {
          if (Ea(u)) return T.none();
          if (s[u.nodeName] || $p(u)) return T.none();
        }
        if (o.hasChildNodes()) {
          if (
            ((i = Math.min(!l && 0 < i ? i - 1 : i, o.childNodes.length - 1)),
            (o = o.childNodes[i]),
            (i = _o.isText(o) && c ? o.data.length : 0),
            !t && o === m.lastChild && $p(o))
          )
            return T.none();
          if (
            ...
            return T.none();
          if (o.hasChildNodes() && !1 === $p(o)) {
            a = new uo((u = o), m);
            do {
              if (_o.isContentEditableFalse(u) || Ea(u)) {
                g = !1;
                break;
              }
      ...
      return (
        ...
        l &&
          ...
          Kp(e, c, t, !1, o).each(function (e) {
            (o = e.container()), (i = e.offset()), (g = !0);
          }),
        g ? T.some(wu(o, i)) : T.none()
      );
    },
    Yp = function (e, t) {
      var n = t.collapsed,
      ...
      return (
        Xp(e, n, !0, r).each(function (e) {
          (n && wu.isAbove(o, e)) || r.setStart(e.container(), e.offset());
        }),
        n ||
          Xp(e, n, !1, r).each(function (e) {
            r.setEnd(e.container(), e.offset());
          }),
        n && r.collapse(!0),
        Cd(t, r) ? T.none() : T.some(r)
      );
    },
    Gp = function (e) {
      return 0 === e.dom().length ? (Vi(e), T.none()) : T.some(e);
    },
    Jp = function (e, t, n) {
      var r, o;
      if (
        ...
        !(function (r, e) {
          ...
          var o = t.bind(Fr).filter(fr).bind(Gp),
            i = n.bind(Ur).filter(fr).bind(Gp);
          Za([o, t.filter(fr)], function (e, t) {
            var n, r;
            (n = t.dom()), (r = e.dom().data), n.insertData(0, r), Vi(e);
          }),
            Za([i, n.filter(fr)], function (e, t) {
              var n = t.dom().length;
              t.dom().appendData(e.dom().data), r.setEnd(t.dom(), n), Vi(e);
            }),
            r.collapse(!1);
    ...
    Zp = function (e, t, n) {
      return Qp(e, t, !0, n, function (e, t) {
        return Math.min(e.dom().childNodes.length, t);
      });
    },
    ev = function (e, t, n) {
      return Qp(e, t, !1, n, function (e, t) {
        return 0 < t ? t - 1 : t;
      });
    },
    tv = function (e, t) {
    ...
    ov = function (e) {
      return !(!e || !e.ownerDocument) && Lr(or.fromDom(e.ownerDocument), or.fromDom(e));
    },
    iv = function (u, s, e, l) {
      var n,
        t,
        ...
        h = function () {
          ...
          if (l.bookmark !== undefined && !1 === nf(l)) {
            var i = Xc(l);
            if (i.isSome())
              return i
                .map(function (e) {
          ...
          return (
            (t = gp(l, [t])[0]) || (t = r.createRange ? r.createRange() : r.body.createTextRange()),
            t.setStart &&
        ...
        a = function (e, t) {
          var n, r;
          if ((o = e) && (rv(o) || (ov(o.startContainer) && ov(o.endContainer)))) {
            var o,
              i = rv(e) ? e : null;
            if (i) {
              f = null;
        ...
        g = {
          ...
          setCursorLocation: function (e, t) {
            var n = u.createRng();
            e ? (n.setStart(e, t), n.setEnd(e, t), a(n), i(!1)) : (Ed(u, n, l.getBody(), !0), a(n));
          },
          ...
          getRng: h,
          getStart: function (e) {
            return Zp(l.getBody(), h(), e);
          },
          getEnd: function (e) {
            return ev(l.getBody(), h(), e);
          },
          getSelectedBlocks: function (e, t) {
            return (function (e, t, n, r) {
              ...
              if (
                ((i = e.getRoot()),
                (n = e.getParent(n || Zp(i, t, t.collapsed), e.isBlock)),
                (r = e.getParent(r || ev(i, t, t.collapsed), e.isBlock)),
                n && n !== i && a.push(n),
                n && r && n !== r)
              )
                for (var u = new uo((o = n), i); (o = u.next()) && o !== r; )
          ...
          getBoundingClientRect: function () {
            var e = h();
            return e.collapsed
              ? Eu.fromRangeStart(e).getClientRects()[0]
      ...
      return (n = ap(g)), (t = lp(g, l)), (g.bookmarkManager = n), (g.controlSelection = t), g;
    },
    av = _o.isText,
    uv = function (e) {
      return av(e) && e.data[0] === ba;
    },
    sv = function (e) {
      return av(e) && e.data[e.data.length - 1] === ba;
    },
    lv = function (e) {
    ...
    cv = function (e, t) {
      return e
        ? (function (e) {
            if (av(e.previousSibling))
              return sv(e.previousSibling) || e.previousSibling.appendData(ba), e.previousSibling;
            if (av(e)) return uv(e) || e.insertData(0, ba), e;
            var t = lv(e);
            return e.parentNode.insertBefore(t, e), t;
          })(t)
        : (function (e) {
            if (av(e.nextSibling))
              return uv(e.nextSibling) || e.nextSibling.insertData(0, ba), e.nextSibling;
            if (av(e)) return sv(e) || e.appendData(ba), e;
            var t = lv(e);
            return (
              e.nextSibling
    ...
    dv = d(cv, !1),
    hv = function (e, t) {
      return _o.isText(e.container()) ? cv(t, e.container()) : cv(t, e.getNode());
    },
    mv = function (e, t) {
      var n = t.get();
    ...
    gv = function (n, e) {
      return e.fold(
        function (e) {
          os.remove(n.get());
          var t = fv(e);
          return n.set(t), T.some(Eu(t, t.length - 1));
        },
        function (e) {
          return tl.firstPositionIn(e).map(function (e) {
            if (mv(e, n)) return Eu(n.get(), 1);
            os.remove(n.get());
            var t = hv(e, !0);
            return n.set(t), Eu(t, 1);
          });
        },
        function (e) {
          return tl.lastPositionIn(e).map(function (e) {
            if (mv(e, n)) return Eu(n.get(), n.get().length - 1);
            os.remove(n.get());
            var t = hv(e, !1);
            return n.set(t), Eu(t, t.length - 1);
          });
        },
        function (e) {
          os.remove(n.get());
          var t = dv(e);
          return n.set(t), T.some(Eu(t, 1));
        }
      );
    },
    pv = /[\u0591-\u07FF\uFB1D-\uFDFF\uFE70-\uFEFC]/,
      ...
      return e
        ...
        : Na(n)
          ? _o.isText(n.previousSibling)
            ? Eu(n.previousSibling, n.previousSibling.data.length)
            : Eu.before(n)
          : ka(t)
            ? Eu(n, r - 1)
            : t;
    ...
    bv = {
      isInlineTarget: function (e, t) {
        ...
        return _r(or.fromDom(t), n);
      },
      findRootInline: function (e, t, n) {
        var r,
          o,
          i,
          a = ((r = e), (o = t), (i = n), V(yi.DOM.getParents(i.container(), '*', o), r));
        return T.from(a[a.length - 1]);
      },
      isRtl: function (e) {
        return 'rtl' === yi.DOM.getStyle(e, 'direction', !0) || ((t = e.textContent), pv.test(t));
        var t;
      },
      isAtZwsp: function (e) {
        return Sa(e) || ka(e);
      },
      normalizePosition: vv,
      normalizeForwards: d(vv, !0),
      normalizeBackwards: d(vv, !1),
    ...
    xv = function (e, t, n) {
      var r = bv.normalizeForwards(n),
        o = wv(t, r.container());
      return bv.findRootInline(e, o, r).fold(function () {
        return tl
          .nextPosition(o, r)
          .bind(d(bv.findRootInline, e, o))
          .map(function (e) {
            return Cv.before(e);
          });
      }, T.none);
    ...
    Ev = function (e, t, n) {
      return bv.findRootInline(e, t, n).filter(d(Nv, t));
    },
    zv = function (e, t, n) {
      var r = bv.normalizeBackwards(n);
      return Ev(e, t, r).bind(function (e) {
        return tl.prevPosition(e, r).isNone() ? T.some(Cv.start(e)) : T.none();
      });
    },
    Sv = function (e, t, n) {
      var r = bv.normalizeForwards(n);
      return Ev(e, t, r).bind(function (e) {
        return tl.nextPosition(e, r).isNone() ? T.some(Cv.end(e)) : T.none();
      });
    },
    kv = function (e, t, n) {
      var r = bv.normalizeBackwards(n),
    ...
    Tv = function (e) {
      return !1 === bv.isRtl(Rv(e));
    },
    Av = function (e, t, n) {
      return yv([xv, zv, Sv, kv], [e, t, n]).filter(Tv);
    },
    Rv = function (e) {
    ...
    Bv = function (n, e, r, t, o, i) {
      return Za([bv.findRootInline(e, r, t), bv.findRootInline(e, r, o)], function (e, t) {
        return e !== t && bv.hasSameParentBlock(r, e, t) ? Cv.after(n ? e : t) : i;
      }).getOr(i);
    },
    Ov = function (e, r) {
      return e.fold($(!0), function (e) {
        return (n = r), !(Mv((t = e)) === Mv(n) && Rv(t) === Rv(n));
        var t, n;
      });
    },
    _v = function (e, t) {
      return e
        ? t.fold(q(T.some, Cv.start), T.none, q(T.some, Cv.after), T.none)
        : t.fold(T.none, q(T.some, Cv.before), T.none, q(T.some, Cv.end));
    },
    Hv = function (a, u, s, l) {
      var e = bv.normalizePosition(a, l),
        c = Av(u, s, e);
      return Av(u, s, e)
        .bind(d(_v, a))
        .orThunk(function () {
          return (
            ...
            (o = c),
            (e = l),
            (i = bv.normalizePosition(t, e)),
            tl
              .fromPosition(t, r, i)
              .map(d(bv.normalizePosition, t))
              .fold(
                function () {
                  return o.map(Dv);
                },
    ...
    Uv = function (e, t, n) {
      var r = e ? 1 : -1;
      return (
        t.setRng(Eu(n.container(), n.offset() + r).toRange()),
    ...
    jv = function (e, t) {
      var n = t.selection.getRng(),
        r = e ? Eu.fromRangeEnd(n) : Eu.fromRangeStart(n);
      return (
        !!Fv(t) && (e && Sa(r) ? Uv(!0, t.selection, r) : !(e || !ka(r)) && Uv(!1, t.selection, r))
      );
    },
    qv = function (e, t) {
      ...
      move: function (a, u, s) {
        return function () {
          return (
            ...
            (e = s),
            (r = t.getBody()),
            (o = Eu.fromRangeStart(t.selection.getRng())),
            (i = d(bv.isInlineTarget, t)),
            Lv(e, i, r, o).bind(function (e) {
              return Kv(t, n, e);
            })).isSome()
          );
          var t, n, e, r, o, i;
            ...
            $v(a) &&
              ...
              (function (e, t) {
                if (e.selection.isCollapsed() && !0 !== e.composing && t.get()) {
                  var n = Eu.fromRangeStart(e.selection.getRng());
                  Eu.isTextPosition(n) &&
                    !1 === bv.isAtZwsp(n) &&
                    (qv(e, os.removeAndReposition(t.get(), n)), t.set(null));
                }
              })(a, u),
              (function (n, r, o, e) {
                if (r.selection.isCollapsed()) {
                  var t = V(e, n);
                  L(t, function (e) {
                    var t = Eu.fromRangeStart(r.selection.getRng());
                    Pv(n, r.getBody(), t).bind(function (e) {
                      return Kv(r, o, e);
                    });
                  });
                }
  ...
  ((ip = op || (op = {}))[(ip.Br = 0)] = 'Br'),
    ...
    (ip[(ip.Eol = 3)] = 'Eol');
  var Gv = function (e, t) {
      return e === xu.Backwards ? t.reverse() : t;
    },
    Jv = function (e, t, n, r) {
      for (
        var o, i, a, u, s, l, c = qs(n), f = r, d = [];
        f && ((s = c), (l = f), (o = t === xu.Forwards ? s.next(l) : s.prev(l)));

      ) {
        if (_o.isBr(o.getNode(!1)))
          return t === xu.Forwards
            ? { positions: Gv(t, d).concat([o]), breakType: op.Br, breakAt: T.some(o) }
            : { positions: Gv(t, d), breakType: op.Br, breakAt: T.some(o) };
        if (o.isVisible()) {
          if (e(f, o)) {
            var h =
              ((i = t),
              (a = f),
              (u = o),
              _o.isBr(u.getNode(i === xu.Forwards)) ? op.Br : !1 === xs(a, u) ? op.Block : op.Wrap);
            return { positions: Gv(t, d), breakType: h, breakAt: T.some(o) };
          }
          d.push(o), (f = o);
        } else f = o;
      }
      return { positions: Gv(t, d), breakType: op.Eol, breakAt: T.none() };
    },
    Qv = function (n, r, o, e) {
      return r(o, e)
        .breakAt.map(function (e) {
          var t = r(o, e).positions;
          return n === xu.Backwards ? t.concat(e) : [e].concat(t);
        })
        .getOr([]);
    },
    Zv = function (e, i) {
      return I(
        ...
        function (e, o) {
          return e.fold(
            ...
            function (r) {
              return Za([te(r.getClientRects()), te(o.getClientRects())], function (e, t) {
    ...
    tb = d(Jv, wu.isAbove, -1),
    nb = d(Jv, wu.isBelow, 1),
    rb = d(Qv, -1, tb),
    ob = d(Qv, 1, nb),
    ib = _o.isContentEditableFalse,
    ab = Ya,
    ub = function (e, t, n, r) {
      var o = e === xu.Forwards,
        i = o ? Nh : Eh;
      if (!r.collapsed) {
        var a = ab(r);
        if (ib(a)) return rh(e, t, a, e === xu.Backwards, !0);
      }
      var u = xa(r.startContainer),
        s = Rs(e, t.getBody(), r);
      if (i(s)) return oh(t, s.getNode(!o));
      var l = bv.normalizePosition(o, n(s));
      if (!l) return u ? r : null;
      if (i(l)) return rh(e, t, l.getNode(!o), o, !0);
      var c = n(l);
      return c && i(c) && Bs(l, c)
        ? rh(e, t, c.getNode(!o), o, !0)
        : u
          ? ah(t, l.toRange(), !0)
          : null;
    },
    sb = function (e, t, n, r) {
      ...
      if (
        ((d = ab(r)),
        (o = Rs(e, t.getBody(), r)),
        (i = n(t.getBody(), qd(1), o)),
        (a = V(i, $d(1))),
        (s = $t.last(o.getClientRects())),
        (Nh(o) || wh(o)) && (d = o.getNode()),
        (Eh(o) || xh(o)) && (d = o.getNode(!0)),
        !s)
      )
        return null;
      if (((l = s.left), (u = Jd(a, l)) && ib(u.node)))
        return (c = Math.abs(l - u.left)), (f = Math.abs(l - u.right)), rh(e, t, u.node, c < f, !0);
      if (d) {
        var h = (function (e, t, n, r) {
          ...
          l = h(
            (u =
              1 === e
                ? ((o = c.next), (i = Xa), (a = Ka), Eu.after(r))
                : ((o = c.prev), (i = Ka), (a = Xa), Eu.before(r)))
          );
          do {
        ...
        if ((u = Jd(V(h, $d(1)), l))) return ah(t, u.position.toRange(), !0);
        if ((u = $t.last(V(h, $d(0))))) return ah(t, u.position.toRange(), !0);
      }
    },
    lb = function (e, t, n) {
      var r,
      ...
      if (n.collapsed && e.settings.forced_root_block) {
        ...
        (1 === t ? s(Eu.fromRangeStart(n)) : l(Eu.fromRangeStart(n))) ||
          ((a = (i = e).dom.create(tc(i))),
      ...
      return function () {
        var e,
          ...
          l =
            ...
            (o = d(Ds, r.next)),
            (i = d(Ds, r.prev)),
            (a = t ? xu.Forwards : xu.Backwards),
            (u = t ? o : i),
            (s = e.selection.getRng()),
            (n = ub(a, e, u, s)) ? n : (n = lb(e, a, s)) || null);
      ...
      return function () {
        var e,
          ...
          a =
            ...
            (n = sb(r, e, o, i)) ? n : (n = lb(e, r, i)) || null);
    ...
    db = function (r, o) {
      return function () {
        var t,
          e = o ? Eu.fromRangeEnd(r.selection.getRng()) : Eu.fromRangeStart(r.selection.getRng()),
          n = o ? nb(r.getBody(), e) : tb(r.getBody(), e);
    ...
    hb = function (e, t, n, r, o) {
      var i,
        ...
        u,
        s,
        l = Gi(or.fromDom(n), 'td,th,caption').map(function (e) {
          return e.dom();
        }),
        c = V(
          ((i = e),
        ...
        .bind(function (e) {
          return eb(
            ...
            tl
              .lastPositionIn(t)
              .map(function (e) {
                return tb(t, e).positions.concat(e);
              })
              .getOr([])),
            n
          );
    ...
    yb = function (e, t, n) {
      var r,
        ...
        a,
        u = e(t, n);
      return ((a = u).breakType === op.Wrap && 0 === a.positions.length) ||
        (!_o.isBr(n.getNode()) && (i = u).breakType === op.Br && 1 === i.positions.length)
        ? ((r = e),
          (o = t),
          !u.breakAt
            .map(function (e) {
    ...
    Nb = function (e, t) {
      var n = t.getNode(e);
      return _o.isElement(n) && 'TABLE' === n.nodeName ? T.some(n) : T.none();
    },
    Eb = function (u, s, l) {
      var e = Nb(!!s, l),
        t = !1 === s;
                ...
                return (
                  ...
                  void ((i = tc((r = u)))
                    ? r.undoManager.transact(function () {
                        ...
                        xr(e, nc(r)),
                          Hi(e, or.fromTag('br')),
                          n ? Oi(or.fromDom(o), e) : Bi(or.fromDom(o), e);
          ...
          (h = vb((i = n), (a = f))
            .orThunk(function () {
              return te(a.getClientRects()).bind(function (e) {
                return Zv(ob(o, Eu.after(i)), e.left);
              });
            })
            .getOr(Eu.after(i))),
          Eb(e, t, h),
        ...
        pb((s = n), (l = f))
          .orThunk(function () {
            return te(l.getClientRects()).bind(function (e) {
              return Zv(rb(u, Eu.before(s)), e.left);
            });
          })
          .getOr(Eu.before(s)));
      return Eb(e, t, h), !0;
    ...
    Mb = function (e, t, n, r) {
      return '' === t
        ? ((c = e), (f = r), (d = or.fromTag('br')), Rb(c, d, f), Ab(d))
        : ((o = e),
          (i = r),
          (a = t),
          (u = n),
    ...
    Bb = function (t, n) {
      var e,
        ...
        a = Eu.fromRangeStart(t.selection.getRng()),
        u = tc(t),
        s = nc(t);
      return ((e = a),
      (r = i),
      (o = d(Pr, r)),
      ea(or.fromDom(e.container()), mo, o).filter(Tb)).exists(function () {
        if (Db(i, n, a)) {
          var e = Mb(i, u, s, n);
    ...
    Lb = function (i, a) {
      i.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          Pb(
            [
              { keyCode: sh.RIGHT, action: cb(t, !0) },
              { keyCode: sh.LEFT, action: cb(t, !1) },
              { keyCode: sh.UP, action: fb(t, !1) },
              { keyCode: sh.DOWN, action: fb(t, !0) },
              { keyCode: sh.RIGHT, action: Sb(t, !0) },
              { keyCode: sh.LEFT, action: Sb(t, !1) },
              { keyCode: sh.UP, action: kb(t, !1) },
              { keyCode: sh.DOWN, action: kb(t, !0) },
              { keyCode: sh.RIGHT, action: Yv.move(t, n, !0) },
              { keyCode: sh.LEFT, action: Yv.move(t, n, !1) },
              {
                keyCode: sh.RIGHT,
                ctrlKey: !o.isOSX(),
                altKey: o.isOSX(),
                action: Yv.moveNextWord(t, n),
              },
              {
                keyCode: sh.LEFT,
                ctrlKey: !o.isOSX(),
                altKey: o.isOSX(),
                action: Yv.movePrevWord(t, n),
              },
              { keyCode: sh.UP, action: Ob(t, !1) },
              { keyCode: sh.DOWN, action: Ob(t, !0) },
            ],
            r
          ).each(function (e) {
            r.preventDefault();
    ...
    Fb = function (i, a, u) {
      return Za([tl.firstPositionIn(u), tl.lastPositionIn(u)], function (e, t) {
        var n = bv.normalizePosition(!0, e),
          r = bv.normalizePosition(!1, t),
          o = bv.normalizePosition(!1, a);
        return i
          ? tl
              .nextPosition(u, o)
              .map(function (e) {
    ...
    $b = function (o, i, e) {
      var t = qb(o, Eu.fromRangeStart(e)),
        n = t.bind(function (e) {
          return tl.fromPosition(i, o, e.position()).bind(function (e) {
            return qb(o, e).map(function (e) {
              return (
                (t = o),
                (n = i),
                (r = e),
                _o.isBr(r.position().getNode()) && !1 === hm(r.block())
                  ? tl
                      .positionIn(!1, r.block().dom())
                      .bind(function (e) {
                        return e.isEqual(r.position())
                          ? tl.fromPosition(n, t, e).bind(function (e) {
                              return qb(t, e);
                            })
                          : T.some(r);
                      })
      ...
      return Za([t, n], jb).filter(function (e) {
        return (
    ...
    Wb = function (e, t, n) {
      return n.collapsed ? $b(e, t, n) : T.none();
    },
    Kb = function (e) {
      var t,
        n =
    ...
    Xb = function (e, t) {
      var n = md(t, e);
      return F(n.reverse(), hm).each(Vi);
    },
    Yb = function (e, t, n, r) {
      if (hm(n)) return Yh(n), tl.firstPositionIn(n.dom());
      0 ===
        V(jr(r), function (e) {
          return !hm(e);
        }).length &&
        hm(t) &&
        Bi(r, or.fromTag('br'));
      var o = tl.prevPosition(n.dom(), Eu.before(r.dom()));
      return (
        L(Kb(t), function (e) {
          Bi(r, e);
        }),
    ...
    Gb = function (e, t, n) {
      if (hm(n)) return Vi(n), hm(t) && Yh(t), tl.firstPositionIn(t.dom());
    ...
    Jb = function (e, t) {
      return Lr(t, e) ? ((n = md(e, t)), T.from(n[n.length - 1])) : T.none();
      var n;
    },
    Qb = function (e, t) {
      tl.positionIn(e, t.dom())
        .map(function (e) {
          return e.getNode();
        })
        .map(or.fromDom)
    ...
    Zb = function (e, t, n) {
      return Qb(!0, t), Qb(!1, n), Jb(t, n).fold(d(Gb, e, t, n), d(Yb, e, t, n));
    },
    ey = function (e, t, n, r) {
    ...
    ty = function (t, n) {
      var e,
        r = or.fromDom(t.getBody());
      return (
        (e = Wb(r.dom(), n, t.selection.getRng()).bind(function (e) {
          return ey(r, n, e.from().block(), e.to().block());
        })).each(function (e) {
    ...
    ny = function (e, t) {
      var n = or.fromDom(t),
        r = d(Pr, e);
      return Zi(n, xo, r).isSome();
    },
    ry = function (e, t) {
      var n,
        r,
        o = tl.prevPosition(e.dom(), Eu.fromRangeStart(t)).isNone(),
        i = tl.nextPosition(e.dom(), Eu.fromRangeEnd(t)).isNone();
      return !(ny((n = e), (r = t).startContainer) || ny(n, r.endContainer)) && o && i;
    },
    oy = function (e) {
      var n,
        r,
      ...
      return ry(i, a)
        ...
        : ((n = i),
          ...
          (o = r.getRng()),
          Za(
            [Vb(n, or.fromDom(o.startContainer)), Vb(n, or.fromDom(o.endContainer))],
            function (e, t) {
              return (
                !1 === Pr(e, t) &&
                (o.deleteContents(),
                ey(n, !0, e, t).each(function (e) {
                  r.setRng(e.toRange());
                }),
                !0)
              );
    ...
    iy = function (e, t) {
      return !e.selection.isCollapsed() && oy(e);
    },
    ay = function (e) {
      return Ms(e).exists(po);
    },
    uy = function (e, t, n) {
      var r = V(md(or.fromDom(n.container()), t), mo),
        o = te(r).getOr(t);
      return tl.fromPosition(e, o.dom(), n).filter(ay);
    },
    sy = function (e, t) {
      return Ms(t).exists(po) || uy(!0, e, t).isSome();
    },
    ly = function (e, t) {
      return ((n = t), T.from(n.getNode(!0)).map(or.fromDom)).exists(po) || uy(!1, e, t).isSome();
      var n;
    },
    cy = d(uy, !1),
    fy = d(uy, !0),
    ...
    hy = function (e, t, n, r) {
      var o = r.getNode(!1 === t);
      return Vb(or.fromDom(e), or.fromDom(n.getNode()))
        .map(function (e) {
          return hm(e) ? dy.remove(e.dom()) : dy.moveToElement(o);
        })
        .orThunk(function () {
          return T.some(dy.moveToElement(o));
        });
    },
    my = function (u, s, l) {
      return tl.fromPosition(s, u, l).bind(function (e) {
        return (
          (a = e.getNode()),
          xo(or.fromDom(a)) || yo(or.fromDom(a))
            ? T.none()
            : ((t = u),
              (o = e),
              (i = function (e) {
                return go(or.fromDom(e)) && !xs(r, o, t);
              }),
              As(!(n = s), (r = l)).fold(function () {
                return As(n, o).fold($(!1), i);
              }, i)
                ? T.none()
        ...
        _o.isElement(a) && a.getAttribute('data-mce-caret') === u
          ? ((t = e),
            ...
            t && _o.isContentEditableFalse(n.nextSibling)
              ? T.some(dy.moveToElement(n.nextSibling))
              : !1 === t && _o.isContentEditableFalse(n.previousSibling)
                ? T.some(dy.moveToElement(n.previousSibling))
                : T.none()).fold(function () {
              return my(r, e, o);
            }, T.some)
          : my(r, e, o).bind(function (e) {
              return (
                (t = r),
                (n = o),
                e.fold(
                  function (e) {
                    return T.some(dy.remove(e));
                  },
                  function (e) {
                    return T.some(dy.moveToElement(e));
                  },
                  function (e) {
                    return xs(n, e, t) ? T.none() : T.some(dy.moveToPosition(e));
                  }
                )
              );
              var t, n;
    ...
    py = function (a, u) {
      ...
      (i = or.fromDom(e)),
      !1 === t && Eh(o)
        ? T.some(dy.remove(o.getNode(!0)))
        : t && Nh(o)
          ? T.some(dy.remove(o.getNode()))
          : !1 === t && Nh(o) && ly(i, o)
            ? cy(i, o).map(function (e) {
                return dy.remove(e.getNode());
              })
            : t && Eh(o) && sy(i, o)
              ? fy(i, o).map(function (e) {
                  return dy.remove(e.getNode());
                })
              : gy(e, t, o))
        .map(function (e) {
          return e.fold(
            ...
            (i = u),
            function (e) {
              return o._selectionOverrides.hideFakeCaret(), Em(o, i, or.fromDom(e)), !0;
            }),
            ((n = a),
            (r = u),
            function (e) {
              var t = r ? Eu.before(e) : Eu.after(e);
    ...
    vy = function (e, t) {
      ...
      return (
        ...
        L(Gi(n, '.mce-offscreen-selection'), Vi),
        Em(e, t, or.fromDom(e.selection.getNode())),
        Ib(e),
        !0)
      );
    },
    by = function (e, t) {
      return e.selection.isCollapsed() ? py(e, t) : vy(e, t);
    },
    yy = function (e) {
      var t,
        n = (function (e, t) {
      ...
      return (
        _o.isContentEditableTrue(n) &&
          ...
          e.dom.setHTML(n, ''),
          n.appendChild(t),
          e.selection.setRng(Eu.before(t).toRange())),
        !0
      );
    },
    Cy = function (e, t, n, r, o, i) {
      var a,
        u,
        s = rh(r, e, i.getNode(!o), o, !0);
      if (t.collapsed) {
        var l = t.cloneRange();
      ...
      return (
        ...
        (a = e.dom),
        (u = n),
        _o.isText(u) && 0 === u.data.length && a.remove(u),
        !0
      );
    },
    wy = function (e, t) {
      return (function (e, t) {
        ...
        if (!_o.isText(n.commonAncestorContainer)) return !1;
        var r = t ? xu.Forwards : xu.Backwards,
          o = qs(e.getBody()),
          i = d(Ds, o.next),
          a = d(Ds, o.prev),
          u = t ? i : a,
          s = t ? Nh : Eh,
          l = Rs(r, e.getBody(), n),
          c = bv.normalizePosition(t, u(l));
        if (!c) return !1;
        if (s(c)) return Cy(e, n, l.getNode(), r, t, c);
        var f = u(c);
        return !!(f && s(f) && Bs(c, f)) && Cy(e, n, l.getNode(), r, t, f);
      })(e, t);
    },
    xy = function (t, n) {
      return function (e) {
        return gv(n, e)
          .map(function (e) {
            return Yv.setCaretPosition(t, e), !0;
          })
          .getOr(!1);
      };
    },
    Ny = function (r, o, i, a) {
      ...
      r.undoManager.ignore(function () {
        ...
        r.selection.setRng(
          ...
          Pv(s, u, Eu.fromRangeStart(r.selection.getRng())).map(Iv).map(xy(r, o));
      }),
        r.nodeChanged();
    },
    Ey = function (n, r, i, o) {
      var e,
        ...
        u = d(bv.isInlineTarget, n),
        s = Pv(u, a, o);
      return s
        .bind(function (e) {
          return i
            ? e.fold($(T.some(Iv(e))), T.none, $(T.some(Vv(e))), T.none)
            : e.fold(T.none, $(T.some(Vv(e))), T.none, $(T.some(Iv(e))));
        })
        .map(xy(n, r))
        .getOrThunk(function () {
          ...
          return s.isSome() && e.isSome()
            ? bv
                ...
                .map(function (e) {
                  return (
                    (o = e),
                    !!Za([tl.firstPositionIn(o), tl.lastPositionIn(o)], function (e, t) {
                      var n = bv.normalizePosition(!0, e),
                        r = bv.normalizePosition(!1, t);
                      return tl
                        .nextPosition(o, n)
            ...
            : e
                .bind(function (e) {
                  return t.map(function (e) {
                    return i ? Ny(n, r, o, e) : Ny(n, r, e, o), !0;
                  });
                })
                .getOr(!1);
        });
    ...
    zy = function (e, t, n) {
      if (e.selection.isCollapsed() && !1 !== e.settings.inline_boundaries) {
        var r = Eu.fromRangeStart(e.selection.getRng());
        return Ey(e, t, n, r);
      }
      return !1;
    },
    ...
    Ty = function (r, o) {
      ...
      return ne(i)
        .map(function (e) {
          var t,
            n = Eu.fromRangeStart(r.selection.getRng());
          return !(!Fb(o, n, e.dom()) || (Ku((t = e).dom()) && km(t.dom())) || (ky(o, r, e, i), 0));
        })
        .getOr(!1);
    },
    Ay = function (e, t) {
      return !!e.selection.isCollapsed() && Ty(e, t);
    },
    Ry = Tr('start', 'end'),
    My = Tr('rng', 'table', 'cells'),
    Dy = Mc([{ removeTable: ['element'] }, { emptyCells: ['cells'] }]),
    By = function (e, t) {
      return ra(or.fromDom(e), 'td,th', t);
    },
    Oy = function (e, t) {
      return ta(e, 'table', t);
    },
    ...
    Hy = function (e, n) {
      return Oy(e.start(), n).bind(function (t) {
        return Oy(e.end(), n).bind(function (e) {
          return Pr(t, e) ? T.some(t) : T.none();
        });
      });
    },
    Py = function (e) {
    ...
    Ly = function (r, e) {
      var t = By(e.startContainer, r),
        n = By(e.endContainer, r);
      return e.collapsed
        ? T.none()
        : Za([t, n], Ry).fold(
            function () {
              return t.fold(
                function () {
                  return n.bind(function (t) {
                    return Oy(t, r).bind(function (e) {
                      return te(Py(e)).map(function (e) {
                        return Ry(e, t);
                      });
                    });
                  });
            ...
            function (e) {
              return Vy(r, e)
                ? T.none()
                : ((n = r),
                  Oy((t = e).start(), n).bind(function (e) {
                    return ne(Py(e)).map(function (e) {
                      return Ry(t.start(), e);
                    });
                  }));
    ...
    Iy = function (e, t) {
      ...
      return ((n = t),
      (r = a),
      (o = By(n.startContainer, r)),
      (i = By(n.endContainer, r)),
      Za([o, i], Ry)
        .filter(_y)
        .filter(function (e) {
          return Vy(r, e);
        ...
        return Hy((t = e), a).map(function (e) {
          return My(t, e, Py(e));
        });
        var t;
      });
    ...
    Uy = function (n) {
      return ((r = n),
      Za([Fy(r.cells(), r.rng().start()), Fy(r.cells(), r.rng().end())], function (e, t) {
        return r.cells().slice(e, t + 1);
      })).map(function (e) {
        var t = n.cells();
        return e.length === t.length ? Dy.removeTable(n.table()) : Dy.emptyCells(e);
      });
      var r;
    },
    jy = function (e, t) {
      return Iy(e, t).bind(Uy);
    },
    qy = function (e, t) {
      return L(t, Yh), e.selection.setCursorLocation(t[0].dom(), 0), !0;
    },
    $y = function (e, t) {
      return Em(e, !1, t), !0;
    },
      ...
      return Xy(e, t)
        .fold(
          function () {
            return (
              (t = n),
              jy(e, r).map(function (e) {
                return e.fold(d($y, t), d(qy, t));
              })
            );
            var t;
          },
    ...
    Xy = function (e, t) {
      return F(md(t, e), function (e) {
        return 'caption' === sr(e);
      });
    },
    Yy = function (e, t) {
      return Yh(t), e.selection.setCursorLocation(t.dom(), 0), T.some(!0);
    },
    Gy = function (u, s, l, c, f) {
      return tl
        ...
        .bind(function (e) {
          return (
            ...
            tl
              ...
              : ((t = c),
                (n = e),
                Xy(s, or.fromDom(n.getNode())).map(function (e) {
                  return !1 === Pr(e, t);
                }))
          );
          var t, n, r, o, i, a;
    ...
    Jy = function (a, u, s, e) {
      var l = Eu.fromRangeStart(a.selection.getRng());
      return Ky(s, e)
        .bind(function (e) {
          return hm(e)
            ? Yy(a, e)
            : ((t = a),
              ...
              (o = e),
              (i = l),
              tl.navigate(r, t.getBody(), i).bind(function (e) {
                return Ky(n, or.fromDom(e.getNode())).map(function (e) {
                  return !1 === Pr(e, o);
                });
              }));
          var t, n, r, o, i;
      ...
      return Xy(s, r).fold(
        function () {
          return (
            ...
            ((e = a),
            (t = u),
            (n = Eu.fromRangeStart(e.selection.getRng())),
            Qy(t, n) ||
              tl
        ...
        function (e) {
          ...
          (r = s),
          (o = e),
          (i = Eu.fromRangeStart(t.selection.getRng())),
          hm(o) ? Yy(t, o) : Gy(t, r, n, o, i)).getOr(!1);
          var t, n, r, o, i;
        }
      );
    },
    eC = function (e, t) {
      ...
      return e.selection.isCollapsed() && 0 === s.length
        ...
        : ((n = e),
          ...
          0 !== (a = _p(n)).length ? qy(n, a) : Wy(n, o, i, r));
    },
    tC = function (e, t) {
      return (
        ...
        ((n = e),
        (r = t),
        (o = Eu.fromRangeStart(n.selection.getRng())),
        tl
          .fromPosition(r, n.getBody(), o)
          .filter(function (e) {
            return r ? yh(e) : Ch(e);
          })
          .bind(function (e) {
            return T.from(Ns(r ? 0 : -1, e));
          })
          .map(function (e) {
    ...
    nC = function (o, i) {
      o.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          Pb(
            [
              { keyCode: sh.BACKSPACE, action: Hb(by, t, !1) },
              { keyCode: sh.DELETE, action: Hb(by, t, !0) },
              { keyCode: sh.BACKSPACE, action: Hb(wy, t, !1) },
              { keyCode: sh.DELETE, action: Hb(wy, t, !0) },
              { keyCode: sh.BACKSPACE, action: Hb(zy, t, n, !1) },
              { keyCode: sh.DELETE, action: Hb(zy, t, n, !0) },
              { keyCode: sh.BACKSPACE, action: Hb(eC, t, !1) },
              { keyCode: sh.DELETE, action: Hb(eC, t, !0) },
              { keyCode: sh.BACKSPACE, action: Hb(tC, t, !1) },
              { keyCode: sh.DELETE, action: Hb(tC, t, !0) },
              { keyCode: sh.BACKSPACE, action: Hb(iy, t, !1) },
              { keyCode: sh.DELETE, action: Hb(iy, t, !0) },
              { keyCode: sh.BACKSPACE, action: Hb(ty, t, !1) },
              { keyCode: sh.DELETE, action: Hb(ty, t, !0) },
              { keyCode: sh.BACKSPACE, action: Hb(Ay, t, !1) },
              { keyCode: sh.DELETE, action: Hb(Ay, t, !0) },
            ],
            r
          ).each(function (e) {
            r.preventDefault();
        ...
        o.on('keyup', function (e) {
          ...
          !1 === e.isDefaultPrevented() &&
            ...
            Pb(
              [
                { keyCode: sh.BACKSPACE, action: Hb(yy, t) },
                { keyCode: sh.DELETE, action: Hb(yy, t) },
              ],
              n
            ));
        });
    ...
    hC = function (e, t, n, r, o) {
      ...
      if (n !== e.getBody()) {
        var u;
        cC((u = n)) && cC(u.parentNode) && (o = 'LI');
        var s,
          l,
          c = o ? t(o) : i.create('BR');
        if (dC(n, r, !0) && dC(n, r, !1)) lC(n, 'LI') ? i.insertAfter(c, fC(n)) : i.replace(c, n);
        else if (dC(n, r, !0))
          lC(n, 'LI')
            ? (i.insertAfter(c, fC(n)), c.appendChild(i.doc.createTextNode(' ')), c.appendChild(n))
            : n.parentNode.insertBefore(c, n);
        else if (dC(n, r, !1)) i.insertAfter(c, fC(n));
        else {
          n = fC(n);
          var f = a.cloneRange();
    ...
    vC = function (e, t, n) {
      return !1 === _o.isText(t)
        ? n
        : e
          ? 1 === n && t.data.charAt(n - 1) === ba
            ? 0
            : n
          : n === t.data.length - 1 && t.data.charAt(n) === ba
            ? t.data.length
            : n;
    },
    bC = function (e, t) {
    ...
    yC = function (e, t) {
      var n = tc(e);
      n && n.toLowerCase() === t.tagName.toLowerCase() && e.dom.setAttribs(t, nc(e));
    },
    CC = function (a, e) {
      var t,
        u,
        ...
        C = function (e) {
          var t, n, r, o;
          if (((o = vC(e, s, i)), _o.isText(s) && (e ? 0 < o : o < s.nodeValue.length))) return !1;
          if (s.parentNode === l && m && !e) return !0;
          if (e && _o.isElement(s) && s === l.firstChild) return !0;
          if (gC(s, 'TABLE') || gC(s, 'HR')) return (m && !e) || (!m && e);
          for (
            t = new uo(s, l),
              _o.isText(s) && (e && 0 === o ? t.prev() : e || o !== s.nodeValue.length || t.next());
            (n = t.current());
        ...
        w = function () {
          (r = /^(H[1-6]|PRE|FIGURE)$/.test(f) && 'HGROUP' !== d ? y(h) : y()),
            ac(a) && pC(g, c) && g.isEmpty(l) ? (r = g.split(c, l)) : g.insertAfter(r, l),
            oC(a, r);
        };
      Yp(g, b).each(function (e) {
      ...
      _o.isElement(s) &&
        ...
        (i = m && _o.isText(s) ? s.nodeValue.length : 0)),
        (u = bC(g, s)) &&
          (((h && !n) || (!h && n)) &&
            (s = (function (e, t, n, r, o) {
              var i,
                ...
                h = e.dom,
                m = bC(h, r);
              if (!(a = h.getParent(r, h.isBlock)) || !pC(h, a)) {
                if (
                  ((c =
                    (a = a || m) === e.getBody() ||
                ...
                if (u && e.schema.isValidChild(c, d.toLowerCase())) {
                  for (
                    i = h.create(d), yC(e, i), u.parentNode.insertBefore(i, u), s = u;
                    s && !h.isBlock(s);
          ...
          /^(LI|DT|DD)$/.test(f) && g.isEmpty(l)
            ...
            : (h && l === a.getBody()) ||
              ((h = h || 'P'),
              xa(l)
                ? ((r = Ma(l)), g.isEmpty(l) && mC(l), oC(a, r))
                : C()
                  ? w()
                  : C(!0)
                    ? ((r = l.parentNode.insertBefore(y(), l)), oC(a, gC(l, 'HR') ? r : l))
                    : ((t = ((S = b),
                      (k = S.cloneRange()),
                      k.setStart(S.startContainer, vC(!0, S.startContainer, S.startOffset)),
                      k.setEnd(S.endContainer, vC(!1, S.endContainer, S.endOffset)),
                      k).cloneRange()).setEndAfter(l),
                      (o = t.extractContents()),
                      (z = o),
                      L(Yi(or.fromDom(z), fr), function (e) {
                        var t = e.dom();
                        t.nodeValue = ya(t.nodeValue);
                      }),
                      (function (e) {
                        for (
                          ;
                          _o.isText(e) && (e.nodeValue = e.nodeValue.replace(/^[\r\n]+/, '')),
                            (e = e.firstChild);
                      ...
                      g.isEmpty(l) && mC(l),
                      r.normalize(),
                      g.isEmpty(r) ? (g.remove(r), w()) : oC(a, r)),
              g.setAttrib(r, 'id', ''),
    ...
    NC = function (e, t) {
      ...
      'LI' !== d || h || (c = f),
        s &&
          ...
          ((function (e, t, n) {
            for (var r, o = new uo(t, n), i = e.getNonEmptyElements(); (r = o.next()); )
    ...
    EC = function (e, t) {
      var n = or.fromTag('br');
      Bi(or.fromDom(t), n), e.undoManager.add();
    },
    zC = function (e, t) {
      SC(e.getBody(), t) || Oi(or.fromDom(t), or.fromTag('br'));
      var n = or.fromTag('br');
      Oi(or.fromDom(t), n),
        wC(e.dom, e.selection, n.dom()),
        xC(e.dom, e.selection, n.dom(), !1),
        e.undoManager.add();
    },
    SC = function (e, t) {
      return (
    ...
    RC = function (e, t) {
      var n,
        ...
        i =
          ((n = e),
          (r = d(bv.isInlineTarget, n)),
          (o = Eu.fromRangeStart(n.selection.getRng())),
          Pv(r, n.getBody(), o).filter(TC));
      i.isSome() ? i.each(d(AC, e)) : NC(e, t);
    },
    MC = function (e, t) {
      return aC(e)
        .filter(function (e) {
          return 0 < t.length && _r(or.fromDom(e), t);
        })
        .isSome();
    },
    DC = function (e) {
    ...
    jC = function (e) {
      var t = tc(e),
        n = iC(e.dom, e.selection.getStart());
    ...
    $C = function (e, t) {
      return yv(
        [
          qC([_C], OC.none()),
          qC([LC('summary', !0)], OC.br()),
          qC([VC(!0), IC(!1), UC], OC.br()),
          qC([VC(!0), IC(!1)], OC.block()),
          qC([VC(!0), IC(!0), UC], OC.block()),
          qC([VC(!0), IC(!0)], OC.br()),
          qC([PC(!0), UC], OC.br()),
          qC([PC(!0)], OC.block()),
          qC([HC(!0), UC, jC], OC.block()),
          qC([HC(!0)], OC.br()),
          qC([FC], OC.br()),
          qC([HC(!1), UC], OC.br()),
          qC([jC], OC.block()),
        ...
        e.keyCode === sh.ENTER &&
          ...
          (n = e).isDefaultPrevented() ||
            ...
            t.undoManager.transact(function () {
              !1 === t.selection.isCollapsed() && t.execCommand('Delete'), WC(t, n);
            })));
      });
    },
    XC = function (n, r) {
      var e = r.container(),
        t = r.offset();
      return _o.isText(e)
        ? (e.insertData(t, n), T.some(wu(e, t + n.length)))
        : Ms(r).map(function (e) {
            var t = or.fromText(n);
            return r.isAtEnd() ? Oi(e, t) : Bi(e, t), wu(t.dom(), n.length);
          });
    },
    YC = d(XC, '\xa0'),
    GC = d(XC, ' '),
    JC = function (e, t, n) {
      return tl.navigateIgnore(e, t, n, gh);
    },
    QC = function (t, n, r) {
      var e = V(md(or.fromDom(r.container()), n), mo);
      return te(e).fold(
        function () {
          return JC(t, n.dom(), r).forall(function (e) {
            return !1 === xs(e, r, n.dom());
          });
        },
        function (e) {
          return JC(t, e.dom(), r).isNone();
        }
      );
    },
    ZC = d(QC, !1),
    ...
    nw = function (e, t) {
      var n = V(md(or.fromDom(t.container()), e), mo);
      return te(n).getOr(e);
    },
    rw = function (e, t) {
      return tw(t) ? mh(t) : mh(t) || tl.prevPosition(nw(e, t).dom(), t).exists(mh);
    },
    ow = function (e, t) {
      return tw(t) ? hh(t) : hh(t) || tl.nextPosition(nw(e, t).dom(), t).exists(hh);
    },
    iw = function (e) {
      return Ms(e)
        .bind(function (e) {
        ...
        .exists(function (e) {
          return (t = zr(e, 'white-space')), P(['pre', 'pre-line', 'pre-wrap'], t);
          var t;
        });
    },
    aw = function (e, t) {
      return (
        (o = e),
        (i = t),
        tl.prevPosition(o.dom(), i).isNone() ||
          ((n = e), (r = t), tl.nextPosition(n.dom(), r).isNone()) ||
          ZC(e, t) ||
          ew(e, t) ||
          ly(e, t) ||
          sy(e, t)
    ...
    uw = function (e, t) {
      var n,
        ...
        i =
          ((r = (n = t).container()),
          (o = n.offset()),
          _o.isText(r) && o < r.data.length ? wu(r, o + 1) : n);
      return !iw(i) && (ew(e, i) || sy(e, i) || ow(e, i));
    },
    sw = function (e, t) {
      return (n = e), (!iw((r = t)) && (ZC(n, r) || ly(n, r) || rw(n, r))) || uw(e, t);
      var n, r;
    },
    lw = function (e, t) {
      return lh(e.charAt(t));
    },
    cw = function (e) {
      var t = e.container();
      return _o.isText(t) && Kn(t.data, '\xa0');
    },
    fw = function (e) {
      var t = e.data,
        n = K(t.split(''), function (e, t, n) {
          return lh(e) && 0 < t && t < n.length - 1 && fh(n[t - 1]) && fh(n[t + 1]) ? ' ' : e;
        }).join('');
      ...
      return T.some(e)
        ...
        .bind(function (e) {
          ...
          return (
            ...
            (u = (a = l).data),
            (s = wu(a, 0)),
            (lw(u, 0) && !sw(i, s) && ((a.data = ' ' + u.slice(1)), 1)) ||
            fw(l) ||
            ((t = c),
            (r = (n = l).data),
            (o = wu(n, r.length - 1)),
            lw(r, r.length - 1) && !sw(t, o) && ((n.data = r.slice(0, -1) + ' '), 1))
              ? T.some(e)
              : T.none()
          );
        });
    ...
    hw = function (t) {
      ...
      t.selection.isCollapsed() &&
        dw(e, wu.fromRangeStart(t.selection.getRng())).each(function (e) {
          t.selection.setRng(e.toRange());
        });
    },
    mw = function (r, o) {
      return function (e) {
        return (t = r), !iw((n = e)) && (aw(t, n) || rw(t, n) || ow(t, n)) ? YC(o) : GC(o);
        var t, n;
      };
    },
    gw = function (e) {
      var t,
        n,
        r = Eu.fromRangeStart(e.selection.getRng()),
        o = or.fromDom(e.getBody());
      if (e.selection.isCollapsed()) {
        var i = d(bv.isInlineTarget, e),
          a = Eu.fromRangeStart(e.selection.getRng());
        return Pv(i, e.getBody(), a)
          .bind(
            ((n = o),
            function (e) {
              return e.fold(
                function (e) {
                  return tl.prevPosition(n.dom(), Eu.before(e));
                },
                function (e) {
                ...
                function (e) {
                  return tl.nextPosition(n.dom(), Eu.after(e));
                }
              );
            })
          )
    ...
    pw = function (r) {
      r.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          Pb([{ keyCode: sh.SPACEBAR, action: Hb(gw, t) }], n).each(function (e) {
            n.preventDefault();
          }));
      });
    },
    vw = function (e, t) {
      ...
      t.hasAttribute('data-mce-caret') &&
        (Ma(t), (n = e).selection.setRng(n.selection.getRng()), e.selection.scrollIntoView(t));
    },
    bw = function (e, t) {
      var n,
        r =
          ((n = e),
          na(or.fromDom(n.getBody()), '*[data-mce-caret]').fold($(null), function (e) {
            return e.dom();
          }));
      if (r)
        return 'compositionstart' === t.type
          ? (t.preventDefault(), t.stopPropagation(), void vw(e, r))
          : void (za(r) && (vw(e, r), e.undoManager.add()));
    },
    yw = function (e) {
      e.on('keyup compositionstart', d(bw, e));
    },
    Cw = nr.detect().browser,
    ww = function (t) {
      var e, n;
      (e = t),
        (n = Fi(function () {
    ...
    xw = function (r) {
      r.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          Pb(
            [
              { keyCode: sh.END, action: db(t, !0) },
              { keyCode: sh.HOME, action: db(t, !1) },
            ],
            n
          ).each(function (e) {
            n.preventDefault();
    ...
    Nw = function (e) {
      ...
      yw(e), Lb(e, t), nC(e, t), KC(e), pw(e), ww(e), xw(e);
    };
  function Ew(u) {
    var s,
      n,
  ...
  var zw = function (e) {
      return _o.isElement(e) && vo(or.fromDom(e));
    },
    Sw = function (t) {
        ...
        3 <= e.detail &&
          (function (e) {
            ...
            if (wu.isElementPosition(n)) {
              var o = n.container();
              zw(o) &&
                tl.firstPositionIn(o).each(function (e) {
            ...
            wu.isElementPosition(r) &&
              ((o = n.container()),
              zw(o) &&
                tl.lastPositionIn(o).each(function (e) {
                  return t.setEnd(e.container(), e.offset());
                })),
              e.selection.setRng(pg(t));
          })(t);
      });
    },
    kw = function (e) {
    ...
    Rw = function (t, e) {
      ...
      f.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        (t.parser =
          ((o = Jg((u = t).settings, u.schema)).addAttributeFilter(
          ...
          o.addNodeFilter('p,h1,h2,h3,h4,h5,h6,div', function (e) {
            for (var t, n = e.length, r = u.schema.getNonEmptyElements(); n--; )
              (t = e[n]).isEmpty(r) &&
                ...
                (t.append(new Il('br', 1)).shortEnded = !0);
          }),
          o)),
        (t.serializer = np(f, t)),
        (t.selection = iv(t.dom, t.getWin(), t.serializer, t)),
        (t.annotator = Hl(t)),
        (t.formatter = Dg(t)),
        (t.undoManager = $h(t)),
        (t._nodeChangeDispatcher = new Sd(t)),
        (t._selectionOverrides = Th(t)),
        kw(t),
        Sw(t),
        Nw(t),
        yd(t),
        ...
        f.browser_spellcheck ||
          f.gecko_spellcheck ||
          ((h.body.spellcheck = !1), Tw.setAttrib(n, 'spellcheck', 'false')),
        (t.quirks = Ew(t)),
        t.fire('PostRender'),
        ...
        0 < t.contentStyles.length &&
          ...
          t.dom.addStyle(r)),
        ((i = t), i.inline ? Tw.styleSheetLoader : i.dom.styleSheetLoader).loadAll(
          t.contentCSS,
          function (e) {
            Aw(t);
          },
    ...
    Dw = function (e, t) {
      var n,
        ...
        (i = or.fromTag('iframe')),
        xr(i, o),
        xr(i, { id: n + '_ifr', frameBorder: '0', allowTransparency: 'true', title: r }),
        Wi(i, 'tox-edit-area__iframe'),
        i).dom();
      u.onload = function () {
      ...
      return (
        ...
        (e.iframeHTML =
          ((f = Yl((s = e)) + '<html><head>'),
          Gl(s) !== s.documentBaseUrl &&
            (f += '<base href="' + s.documentBaseURI.getURI() + '" />'),
          (f += '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />'),
          (l = Jl(s)),
          (c = Ql(s)),
          Zl(s) && (f += '<meta http-equiv="Content-Security-Policy" content="' + Zl(s) + '" />'),
          (f +=
            '</head><body id="' +
            l +
    ...
    Bw = function (e, t) {
      var n = Dw(e, t);
      t.editorContainer &&
        ((Mw.get(t.editorContainer).style.display = e.orgDisplay),
        (e.hidden = Mw.isHidden(t.editorContainer))),
        (e.getElement().style.display = 'none'),
        Mw.setAttrib(e.id, 'aria-hidden', 'true'),
        n || Rw(e);
    },
    Ow = function (e) {
      var t, n, r, o, i;
    ...
    Hw = function (t, n, e) {
      var r = Xf.get(e),
        o = Xf.urls[e] || t.documentBaseUrl.replace(/\/$/, '');
      if (((e = Gt.trim(e)), r && -1 === Gt.inArray(n, e))) {
        if (
          (Gt.each(Xf.dependencies(e), function (e) {
            Hw(t, n, e);
          }),
          t.plugins[e])
        )
    ...
    Vw = function (e) {
      var t,
        n,
        r = e.getElement();
      return e.inline ? Lw(null) : ((t = r), (n = _w.create('div')), _w.insertAfter(n, t), Lw(n));
    },
    Iw = function (e) {
      var n, t, r, o, i, a;
      e.fire('ScriptsLoaded'),
        ...
        mr(o, function (e, t) {
          yr(r, t) || n.ui.registry.addIcon(t, e);
        }),
        (function (e) {
          var t = e.settings.theme;
          if (A(t)) {
            e.settings.theme = Pw(t);
            var n = Yf.get(t);
            (e.theme = new n(e, Yf.urls[t])),
              e.theme.init &&
                e.theme.init(e, Yf.urls[t] || e.documentBaseUrl.replace(/\/$/, ''), e.$);
          } else e.theme = {};
        })(e),
        (i = e),
        (a = []),
      ...
      var u,
        ...
        h =
          ((f = (u = e).settings),
          (d = u.getElement()),
          (u.orgDisplay = d.style.display),
          A(f.theme)
            ? u.theme.renderUI()
            : O(f.theme)
              ? ((l = (s = u).getElement()),
                (c = s.settings.theme(s, l)).editorContainer.nodeType &&
                  (c.editorContainer.id = c.editorContainer.id || s.id + '_parent'),
                c.iframeContainer &&
                  c.iframeContainer.nodeType &&
                  (c.iframeContainer.id = c.iframeContainer.id || s.id + '_iframecontainer'),
                (c.height = c.iframeHeight ? c.iframeHeight : l.offsetHeight),
                c)
              : Vw(u));
      return (
        (e.editorContainer = h.editorContainer ? h.editorContainer : null),
        Ow(e),
        e.inline ? Rw(e) : Bw(e, h)
      );
    },
    Fw = yi.DOM,
    Uw = function (e) {
    ...
    jw = function (a, u) {
      var s = Ei.ScriptLoader;
      !(function (e, t, n, r) {
        var o = t.settings,
          i = o.theme;
        if (A(i)) {
          if (!Uw(i) && !Yf.urls.hasOwnProperty(i)) {
            var a = o.theme_url;
            a
              ? Yf.load(i, t.documentBaseURI.toAbsolute(a))
              : Yf.load(i, 'themes/' + i + '/theme' + n + '.js');
          }
        ...
        (e = s),
          ...
          (function (e) {
            var t = Gt.trim(e.getParam('icons', '', 'string'));
            if (0 < t.length && !Kf.has(t)) {
              var n = e.editorManager.baseURL + '/icons/' + t + '/icons.js';
              Ei.ScriptLoader.add(n);
            }
          })(a),
          (o = a.settings),
          (i = u),
          ...
          Gt.each(o.external_plugins, function (e, t) {
            Xf.load(t, e), (o.plugins += ' ' + t);
          }),
          Gt.each(o.plugins.split(/[ ,]/), function (e) {
            if ((e = Gt.trim(e)) && !Xf.urls[e])
              if (Uw(e)) {
                e = e.substr(1, e.length);
                var t = Xf.dependencies(e);
                Gt.each(t, function (e) {
                  var t = { prefix: 'plugins/', resource: e, suffix: '/plugin' + i + '.js' };
                  (e = Xf.createUrl(t, e)), Xf.load(e.resource, e);
                });
              } else Xf.load(e, { prefix: 'plugins/', resource: e, suffix: '/plugin' + i + '.js' });
          }),
          s.loadQueue(
            function () {
              a.removed || Iw(a);
            ...
            a,
            function (e) {
              Wf.pluginLoadError(a, e[0]), a.removed || Iw(a);
            }
          );
      });
    },
    qw = function (t) {
      ...
      Ri.setCode(bc(t));
      var r = function () {
        Fw.unbind(j.window, 'ready', r), t.render();
      };
      if (ke.Event.domLoaded) {
        if (t.getElement() && he.contentEditable) {
          ...
          var o = t.getElement().form || Fw.getParent(n, 'form');
          o &&
            ((t.formElement = o),
            e.hidden_input &&
              !/TEXTAREA|INPUT/i.test(t.getElement().nodeName) &&
              (Fw.insertAfter(Fw.create('input', { type: 'hidden', name: n }), n),
              (t.hasHiddenInput = !0)),
            (t.formEventDelegate = function (e) {
              t.fire(e.type, e);
            }),
            Fw.bind(o, 'submit reset', t.formEventDelegate),
            t.on('reset', function () {
            ...
            (t.windowManager = Vf(t)),
            (t.notificationManager = Lf(t)),
            'xml' === e.encoding &&
              t.on('GetContent', function (e) {
                e.save && (e.content = Fw.encode(e.content));
              }),
    ...
    Ww = function (e, t, n) {
      var r, o;
      Xi(e, t) && !1 === n
        ? ((o = t), ji((r = e)) ? r.dom().classList.remove(o) : $i(r, o), Ki(r))
        : n && Wi(e, t);
    },
    Kw = function (e, t) {
      Ww(or.fromDom(e.getBody()), 'mce-content-readonly', t),
        t
    ...
    Jw = function (e) {
      return 0 < e.length && (!(t = e[e.length - 1]).firstChild || Gw(t)) ? e.slice(0, -1) : e;
      var t;
    },
    Qw = function (e, t) {
    ...
    nx = function (e, o, i, t) {
      var n,
        ...
        z = Jw(Yw(N.firstChild)),
        S = o.getRoot(),
        k = function (e) {
          var t = Eu.fromRangeStart(i),
            n = qs(o.getRoot()),
      ...
      return k(1)
        ? ex(E, z, S)
        : k(2)
          ? ((f = E), (d = z), (h = S), o.insertAfter(d.reverse(), f), Zw(d[0], h))
          : ((g = z),
            (p = S),
            (v = m = E),
            (y = (b = i).cloneRange()),
    ...
    ax = function (e, t, n) {
      ...
      if (
        ...
        (r = e.parser),
        (h = n.merge),
        (o = Sc({ validate: e.settings.validate }, e.schema)),
        ...
        x === N &&
          ...
          m.isCollapsed() ||
            (e.selection.setRng(pg(e.selection.getRng())),
        ...
        if (((u = r.parse(t, k)), !0 === n.paste && tx(e.schema, u) && rx(g, i)))
          return (
            (c = nx(o, g, e.selection.getRng(), u)),
        ...
        if ((e._selectionOverrides.showBlockCaretContainer(i), k.invalid)) {
          for (
            ix(e, d), i = m.getNode(), a = e.getBody(), 9 === i.nodeType ? (i = f = a) : (f = i);
            f !== a;
          ...
          !(function (e, t, n) {
            if ('all' === n.getAttribute('data-mce-bogus'))
              ...
              var r = n.firstChild,
                o = n.lastChild;
              !r || (r === o && 'BR' === r.nodeName) ? e.dom.setHTML(n, t) : ix(e, t);
            }
          })(e, (t = o.serialize(u)), i);
        !(function (e, t) {
            ...
            if (e) {
              ...
              (i = e.previousSibling) && 3 === i.nodeType
                ...
                r &&
                  ...
                  !(o = (function (e) {
                    var t = Eu.fromRangeStart(e);
                    if ((t = qs(n.getBody()).next(t))) return t.toRange();
                  })(l))
          ...
          T.from(z.getParent(S, 'td,th')).map(or.fromDom).each(Gh),
          e.fire('SetContent', s),
          e.addVisual();
      }
    },
        ...
        return T.from(e)
          ...
          .bind(function (e) {
            ...
            ea(
              ...
              function (e) {
                return Pr(or.fromDom(o), e);
              }
            ).bind(a)).or(((t = s), (n = e.dom()), T.from(yi.DOM.getStyle(n, t, !0))));
            var t, n, r, o, i, a;
          })
          .getOr('');
      };
    ...
    Cx = function (e) {
      return V(K(e.selection.getSelectedBlocks(), or.fromDom), function (e) {
        return (
          ...
          !Ir(e).map(yx).getOr(!1) &&
          ea(e, function (e) {
            return _o.isContentEditableTrue(e.dom()) || _o.isContentEditableFalse(e.dom());
          }).exists(function (e) {
            return _o.isContentEditableTrue(e.dom());
          })
        );
      });
    },
      ...
      e.queryCommandState('InsertUnorderedList') ||
        ...
        L(Cx(e), function (e) {
          !(function (e, t, n, r, o, i) {
            var a = vx(n, or.fromDom(i));
            if ('outdent' === t) {
              var u = Math.max(0, px(i.style[a]) - r);
              e.setStyle(i, a, u ? u + o : '');
            } else (u = px(i.style[a]) + r + o), e.setStyle(i, a, u);
          })(n, t, s, u, a, e.dom());
        });
    },
    xx = Gt.each,
  ...
  function Sx(s) {
    ...
    var e = function (e, n) {
        (n = n || 'exec'),
          xx(e, function (t, e) {
            xx(e.toLowerCase().split(','), function (e) {
              l[n][e] = t;
            });
          });
      },
    ...
    e({
      ...
      'JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone': function (e) {
        var t = e.substring(7);
        'full' === t && (t = 'justify'),
          xx('left,center,right,justify'.split(','), function (e) {
      ...
      FontName: function (e, t, n) {
        var r, o;
        (o = n), (r = s).formatter.toggle('fontname', { value: gx(r, o) }), r.nodeChanged();
      },
      FontSize: function (e, t, n) {
        var r, o;
        (o = n), (r = s).formatter.toggle('fontsize', { value: gx(r, o) }), r.nodeChanged();
      },
        ...
        function () {
          return mx((t = s)).fold(
            function () {
              return hx(t)
                .map(function (e) {
                  return dx.getFontFamily(t.getBody(), e);
                })
                .getOr('');
            },
            function (e) {
        ...
        function () {
          return mx((t = s)).fold(
            function () {
              return hx(t)
                .map(function (e) {
                  return dx.getFontSize(t.getBody(), e);
                })
                .getOr('');
            },
            function (e) {
  ...
  Tx.isNative = function (e) {
    return !!kx[e.toLowerCase()];
  };
  var Ax,
    Rx = function (n) {
      return (
        n._eventDispatcher ||
          (n._eventDispatcher = new Tx({
            scope: n,
            toggleEvent: function (e, t) {
              Tx.isNative(e) && n.toggleNativeEvent && n.toggleNativeEvent(e, t);
            },
          })),
        n._eventDispatcher
      );
    ...
    Mx = {
      fire: function (e, t, n) {
        ...
        if (((t = Rx(this).fire(e, t, n)), !1 !== n && this.parent))
          for (var r = this.parent(); r && !t.isPropagationStopped(); )
            r.fire(e, t, !1), (r = r.parent());
        return t;
      },
      on: function (e, t, n) {
        return Rx(this).on(e, t, n);
      },
      off: function (e, t) {
        return Rx(this).off(e, t);
      },
      once: function (e, t) {
        return Rx(this).once(e, t);
      },
      hasEventListeners: function (e) {
        return Rx(this).has(e);
      },
    },
    Dx = yi.DOM,
    Bx = function (e, t) {
      return 'selectionchange' === t
        ...
        : !e.inline && /^mouse|touch|click|contextmenu|drop|dragover|dragend/.test(t)
          ...
          : e.settings.event_root
            ? (e.eventRoot || (e.eventRoot = Dx.select(e.settings.event_root)[0]), e.eventRoot)
            : e.getBody();
    },
    Ox = function (e, t, n) {
      var r;
    ...
    _x = function (i, a) {
      ...
      if ((i.delegates || (i.delegates = {}), !i.delegates[a] && !i.removed))
        if (((e = Bx(i, a)), i.settings.event_root)) {
          if (
            (Ax ||
              ((Ax = {}),
              i.editorManager.on('removeEditor', function () {
                var e;
                if (!i.editorManager.activeEditor && Ax) {
                  for (e in Ax) i.dom.unbind(Bx(i, e));
                  Ax = null;
                }
              })),
            Ax[a])
          ...
          (t = function (e) {
            for (var t = e.target, n = i.editorManager.get(), r = n.length; r--; ) {
              var o = n[r].getBody();
              (o === t || Dx.isChildOf(t, o)) && Ox(n[r], a, e);
            }
          }),
            (Ax[a] = t),
            Dx.bind(e, a, t);
    ...
    Hx = {
      ...
      toggleNativeEvent: function (e, t) {
        ...
        'focus' !== e &&
          ...
          (t
            ...
            : n.initialized && (n.dom.unbind(Bx(n, e), e, n.delegates[e]), delete n.delegates[e]));
      },
      unbindAllNativeEvents: function () {
        var e,
          ...
          r = t.dom;
        if (t.delegates) {
          for (e in t.delegates) t.dom.unbind(Bx(t, e), e, t.delegates[e]);
          delete t.delegates;
        }
    ...
    Fx = Gt.makeMap('alt,ctrl,shift,meta,access');
  function Ux(i) {
    var a = {},
      r = [],
      u = function (e) {
      ...
      s = function (e, t, n, r) {
        var o;
        return (
          ((o = Gt.map(Vx(e, '>'), u))[o.length - 1] = Gt.extend(o[o.length - 1], {
            func: n,
            scope: r || i,
          })),
    ...
    i.on('keyup keypress keydown', function (t) {
      ...
      (this.add = function (e, n, r, o) {
        ...
        return (
          ...
          Lx(Vx(Gt.trim(e.toLowerCase())), function (e) {
            var t = s(e, n, r, o);
            a[t.id] = t;
          }),
          !0
  ...
  var jx = Gt.each,
    ...
    Wx = { ftp: 21, http: 80, https: 443, mailto: 25 },
    Kx = function (r, e) {
      var t,
        n,
        o = this;
      if (
        ...
        0 !== r.indexOf('/') || i || (r = ((t && t.protocol) || 'http') + '://mce_host' + r),
          /^[\w\-]*:?\/\//.test(r) ||
            ((n = e.base_uri ? e.base_uri.path : new Kx(j.document.location.href).directory),
            (r =
              '' == e.base_uri.protocol
  ...
  (Kx.prototype = {
    ...
    toRelative: function (e) {
      ...
      if ('./' === e) return e;
      if (
        ('mce_host' !== (e = new Kx(e, { base_uri: this })).host &&
          this.host !== e.host &&
          e.host) ||
        this.port !== e.port ||
  ...
  var Xx = function () {
        ...
        s =
          ...
          (a = {}),
          {
            addButton: (u = function (n, r) {
              return function (e, t) {
                return (n[e.toLowerCase()] = _g({ type: r }, t));
              };
            })((e = {}), 'button'),
    ...
    eN = function (e, t, n) {
      ...
      (r = c),
        ...
        c.setDirty(!1),
        (c.plugins = {}),
        (c.documentBaseURI = new Kx(t.document_base_url, { base_uri: d })),
        (c.baseURI = d),
        (c.contentCSS = []),
        (c.contentStyles = []),
        (c.shortcuts = new Ux(c)),
        (c.loadedCSS = {}),
        (c.editorCommands = new Sx(c)),
        (c.suffix = n.suffix),
        (c.editorManager = n),
        (c.inline = t.inline),
        (c.buttons = {}),
    ...
    (eN.prototype = {
      ...
      show: function () {
        this.hidden &&
          ...
          this.inline
            ...
            : (Yx.show(this.getContainer()), Yx.hide(this.id)),
          this.load(),
          this.fire('show'));
      },
      hide: function () {
        var e = this,
          t = e.getDoc();
        e.hidden ||
          (Zx && t && !e.inline && t.execCommand('SelectAll'),
          e.save(),
          e.inline
            ? ((e.getBody().contentEditable = !1),
              e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null))
            : (Yx.hide(e.getContainer()), Yx.setStyle(e.id, 'display', e.orgDisplay)),
          (e.hidden = !0),
          e.fire('hide'));
      },
      isHidden: function () {
          ...
          return (
            ...
            /TEXTAREA|INPUT/i.test(o.nodeName)
              ...
              : ((!e.is_removing && r.inline) || (o.innerHTML = t),
                (n = Yx.getParent(r.id, 'form')) &&
                  Jx(n.elements, function (e) {
      ...
      getContent: function (e) {
        return (
          (t = this),
          void 0 === (n = e) && (n = {}),
          T.from(t.getBody()).fold($('tree' === n.format ? new Il('body', 11) : ''), function (e) {
            return Nc(t, n, e);
          })
        );
        var t, n;
      ...
      insertContent: function (e, t) {
        t && (e = Gx({ content: e }, t)), this.execCommand('mceInsertContent', !1, e);
      },
      isDirty: function () {
      ...
      getContainer: function () {
        return (
          this.container || (this.container = Yx.get(this.editorContainer || this.id + '_parent')),
          this.container
        );
      },
      ...
      getElement: function () {
        return this.targetElm || (this.targetElm = Yx.get(this.id)), this.targetElm;
      },
      getWin: function () {
        var e;
        return (
      ...
      addVisual: function (e) {
        ...
        (e = e || r.getBody()),
          ...
          Jx(i.select('table,a', e), function (e) {
            var t;
            switch (e.nodeName) {
              case 'TABLE':
                return (
  ...
  var tN,
    ...
    iN = function (n, e) {
      ...
      nr.detect().browser.isIE()
        ...
        n.on('keyup nodechange', function (e) {
          var t;
          ('nodechange' === (t = e).type && t.selectionChange) || Wc(n);
        });
    },
    aN = function (e) {
      var t,
      ...
      e.inline &&
        ...
        yi.DOM.bind(j.document, 'mouseup', r),
        t.on('remove', function () {
          yi.DOM.unbind(j.document, 'mouseup', r);
        })),
        e.on('init', function () {
          iN(e, o);
        }),
    ...
    uN = yi.DOM,
    sN = function (e) {
      return oN.isEditorUIElement(e);
    },
    lN = function (t, e) {
      var n = t ? t.settings.custom_ui_selector : '';
      return (
        null !==
        uN.getParent(e, function (e) {
          return sN(e) || (!!n && t.dom.is(e, n));
        })
      );
    },
    cN = function (r, e) {
      ...
      aN(t),
        ...
        tN ||
          ...
          uN.bind(j.document, 'focusin', tN));
    },
    fN = function (e, t) {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        e.activeEditor || (uN.unbind(j.document, 'focusin', tN), (tN = null));
    },
    dN = function (e) {
      e.on('AddEditor', d(cN, e)), e.on('RemoveEditor', d(fN, e));
    },
    hN = yi.DOM,
    mN = Gt.explode,
    gN = Gt.each,
    ...
    xN = function (e) {
      e !== bN &&
        (e ? pn(window).on('resize scroll', wN) : pn(window).off('resize scroll', wN), (bN = e));
    },
    NN = function (t) {
      var e = CN;
      delete yN[t.id];
      ...
      return (
        ...
        rN.activeEditor === t && (rN.activeEditor = 0 < CN.length ? CN[0] : null),
        rN.focusedEditor === t && (rN.focusedEditor = null),
        e.length !== CN.length
      );
    };
  pN(
    (rN = {
      ...
      setup: function () {
        var e,
          ...
          o = '';
        if (
          ((t = Kx.getDocumentBaseUrl(j.document.location)),
          /^[^:]+:\/\/\/?[^\/]+\//.test(t) &&
            ((t = t.replace(/[\?#].*$/, '').replace(/[\/\\][^\/]+$/, '')),
            /[\/\\]$/.test(t) || (t += '/')),
      ...
      overrideDefaults: function (e) {
        var t, n;
        (t = e.base_url) &&
          ((this.baseURL = new Kx(this.documentBaseURL).toAbsolute(t.replace(/\/+$/, ''))),
          (this.baseURI = new Kx(this.baseURL))),
          (n = e.suffix),
      ...
      init: function (r) {
        ...
        var l = function (e) {
            ...
            return (
              t ||
                ((t = (t = e.name) && !hN.get(t) ? e.name : hN.uniqueId()),
                e.setAttribute('id', t)),
              t
            );
          },
                    ...
                    case 'exact':
                      0 < (e = t.elements || '').length &&
                        gN(mN(e), function (t) {
                          ...
                          (e = hN.get(t))
                            ? n.push(e)
                            : gN(j.document.forms, function (e) {
      ...
      add: function (e) {
        ...
        return (
          yN[e.id] === e ||
            (null === t.get(e.id) && ('length' !== e.id && (yN[e.id] = e), yN.push(e), CN.push(e)),
            xN(!0),
            (t.activeEditor = e),
            ...
            nN ||
              ...
              hN.bind(window, 'beforeunload', nN))),
          e
        );
      },
      createEditor: function (e, t) {
        return this.add(new eN(e, t, this));
      },
      remove: function (e) {
        var t,
          n,
        ...
        if (e) {
          if (!A(e))
            return (
              ...
              D(r.get(n.id))
                ? null
                : (NN(n) && r.fire('RemoveEditor', { editor: n }),
                  0 === CN.length && hN.unbind(window, 'beforeunload', nN),
                  n.remove(),
                  xN(0 < CN.length),
                  n)
            );
        ...
        } else for (t = CN.length - 1; 0 <= t; t--) r.remove(CN[t]);
      },
      execCommand: function (e, t, n) {
        var r = this.get(n);
        switch (e) {
          case 'mceAddEditor':
            return this.get(n) || new eN(n, this.settings, this).render(), !0;
  ...
  function SN(n) {
    return {
      ...
      normalize: function (t) {
        return Yp(n, t).fold($(!1), function (e) {
          return (
  ...
  ((EN = SN || (SN = {})).compareRanges = Cd),
    (EN.getCaretRangeFromPoint = mp),
    (EN.getSelectedNode = Ya),
    (EN.getNode = Ga);
  var kN,
    TN,
    AN = SN,
    ...
    _N = {
      ...
      intersect: function (e, t) {
        ...
        return (
          (n = MN(e.x, t.x)),
          (r = MN(e.y, t.y)),
          (o = RN(e.x + e.w, t.x + t.w)),
          (i = RN(e.y + e.h, t.y + t.h)),
  ...
  LN.extend = kN = function (n) {
    ...
    (TN = !1),
    n.Mixins &&
      (HN(n.Mixins, function (e) {
        for (var t in e) 'init' !== t && (n[t] = e[t]);
      }),
      o.Mixins && (n.Mixins = o.Mixins.concat(n.Mixins))),
    n.Methods &&
      HN(n.Methods.split(','), function (e) {
        n[e] = a;
      }),
    n.Properties &&
      HN(n.Properties.split(','), function (e) {
        var t = '_' + e;
        n[e] = function (e) {
      ...
      send: function (e) {
        ...
        if (
          ...
          if (
            ...
            (t = qN.fire('beforeSend', { xhr: t, settings: e }).xhr).send(e.data),
            !e.async)
          )
            return r();
          be.setTimeout(r, 10);
  ...
  (GN.sendRPC = function (e) {
    return new GN().send(e);
  }),
    (GN.prototype = {
      send: function (n) {
        var r = n.error,
          o = n.success;
        ((n = YN(this.settings, n)).success = function (e, t) {
                    ...
                    : 'v' in e &&
                      (function (e, t, n) {
                        ...
                        if (
                          ...
                          (u = FN(255 * (u + a))), (s = FN(255 * (s + a))), (l = FN(255 * (l + a)));
                        } else u = s = l = FN(255 * n);
                      })(e.h, e.s, e.v)
          ...
          return (
            ...
            (n.toHsv = function () {
              return (
                ...
                (n = l),
                (o = 0),
                (i = VN((e /= 255), VN((t /= 255), (n /= 255)))) === (a = IN(e, IN(t, n)))
                  ? { h: 0, s: 0, v: 100 * (o = i) }
                  : ((r = (a - i) / a),
                    {
                      h: FN(
