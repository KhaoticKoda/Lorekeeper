...
@section('content')
    ...
    <h1>RSS Feeds</h1>
	<p class="mb-2">RSS feeds are automatically-updating files containing blog posts, news updates, or other content that you can keep track of using an RSS feed reader of your choice. To keep up with any of the feeds below, simply paste their link where your RSS reader prompts you!</p>
