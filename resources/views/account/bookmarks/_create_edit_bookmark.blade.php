<p>
  All information entered into a bookmark is strictly private - the owner of the bookmarked character will not be
  notified, and will not know who/how many users have bookmarked their character.
</p>
{!! Form::open([
...
<div class="form-group">
  ...
  <div class="form-check">
    {!! Form::checkbox('notify_on_gift_writing_status', 1, $bookmark->notify_on_gift_writing_status, [
        'class' => 'form-check-input',
        'id' => 'notifyGiftArt',
    ]) !!}
