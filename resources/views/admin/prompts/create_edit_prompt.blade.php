...
@section('admin-content')
    ...
    @include('widgets._add_rewards', [
        ...
        'showRecipient'  => true,
        'info'           =>
            '<p>User rewards are credited on a per-user basis, character rewards are rewarded to all characters attached. Mods are able to modify the specific rewards granted at approval time.</p>
