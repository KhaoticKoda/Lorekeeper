...
class Character extends Model {
    ...
    **********************************************************************************************/
    ...
    public function getMentionImageAttribute() {
        return '<span data-mention-type="character" data-id="'.$this->id.'"><a href="'.$this->url.'"><img class="img-fluid rounded" src="'.$this->image->thumbnailUrl.'" alt="'.$this->name.'" class="mention-thumbnail"></a></span>';
    }
